...
def _f(function):
    return _p.createFunction(
        function, _p.PLATFORM.GLES2, "GLES2_OES_tessellation_shader", error_checker=_errors._error_checker
    )
...
GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS_OES = _C(
