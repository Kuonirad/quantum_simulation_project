...
def _f(function):
    return _p.createFunction(
        function, _p.PLATFORM.GLES2, "GLES2_NV_path_rendering", error_checker=_errors._error_checker
    )
...
def glPathMemoryGlyphIndexArrayNV(
...
@_f
@_p.types(
    None, _cs.GLsizei, _cs.GLenum, ctypes.c_void_p, _cs.GLuint, _cs.GLenum, _cs.GLuint, _cs.GLenum, arrays.GLfloatArray
)
def glStencilFillPathInstancedNV(
...
@_f
@_p.types(
    None, _cs.GLsizei, _cs.GLenum, ctypes.c_void_p, _cs.GLuint, _cs.GLint, _cs.GLuint, _cs.GLenum, arrays.GLfloatArray
)
def glStencilStrokePathInstancedNV(
...
def glStencilThenCoverStrokePathInstancedNV(
