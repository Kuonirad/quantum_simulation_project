...
def _f(function):
    return _p.createFunction(
        function, _p.PLATFORM.GLES2, "GLES2_EXT_memory_object", error_checker=_errors._error_checker
    )
...
def glTexStorageMem2DMultisampleEXT(
...
def glTexStorageMem3DMultisampleEXT(
...
def glTextureStorageMem2DMultisampleEXT(
...
def glTextureStorageMem3DMultisampleEXT(
