...
def _f(function):
    return _p.createFunction(
        function, _p.PLATFORM.GLES2, "GLES2_EXT_sparse_texture", error_checker=_errors._error_checker
    )
...
@_f
@_p.types(
    None, _cs.GLenum, _cs.GLint, _cs.GLint, _cs.GLint, _cs.GLint, _cs.GLsizei, _cs.GLsizei, _cs.GLsizei, _cs.GLboolean
)
def glTexPageCommitmentEXT(target, level, xoffset, yoffset, zoffset, width, height, depth, commit):
    pass
