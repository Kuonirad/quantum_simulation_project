...
def _f(function):
    return _p.createFunction(
        function, _p.PLATFORM.GLES2, "GLES2_VERSION_GLES2_2_0", error_checker=_errors._error_checker
    )
...
@_f
@_p.types(
    None, _cs.GLenum, _cs.GLint, _cs.GLint, _cs.GLsizei, _cs.GLsizei, _cs.GLint, _cs.GLenum, _cs.GLenum, ctypes.c_void_p
)
...
@_f
@_p.types(
    None, _cs.GLenum, _cs.GLint, _cs.GLint, _cs.GLint, _cs.GLsizei, _cs.GLsizei, _cs.GLenum, _cs.GLenum, ctypes.c_void_p
)
