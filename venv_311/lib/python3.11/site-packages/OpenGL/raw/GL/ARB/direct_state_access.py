...
def _f(function):
    return _p.createFunction(
        function, _p.PLATFORM.GL, "GL_ARB_direct_state_access", error_checker=_errors._error_checker
    )
...
@_f
@_p.types(
    None, _cs.GLuint, _cs.GLint, _cs.GLint, _cs.GLint, _cs.GLsizei, _cs.GLsizei, _cs.GLenum, _cs.GLenum, ctypes.c_void_p
)
...
@_f
@_p.types(
    None, _cs.GLuint, _cs.GLuint, _cs.GLsizei, arrays.GLuintArray, ctypes.POINTER(_cs.GLintptr), arrays.GLsizeiArray
)
