...
def _f(function):
    return _p.createFunction(
        function, _p.PLATFORM.GL, "GL_EXT_direct_state_access", error_checker=_errors._error_checker
    )
...
def glCompressedMultiTexImage3DEXT(
...
def glCompressedMultiTexSubImage3DEXT(
...
def glCompressedTextureImage3DEXT(
...
def glCompressedTextureSubImage3DEXT(
...
@_f
@_p.types(
    None, _cs.GLenum, _cs.GLenum, _cs.GLint, _cs.GLenum, _cs.GLint, _cs.GLint, _cs.GLsizei, _cs.GLsizei, _cs.GLint
)
...
@_f
@_p.types(
    None, _cs.GLuint, _cs.GLenum, _cs.GLint, _cs.GLenum, _cs.GLint, _cs.GLint, _cs.GLsizei, _cs.GLsizei, _cs.GLint
)
...
@_f
@_p.types(
    None, _cs.GLenum, _cs.GLenum, _cs.GLint, _cs.GLint, _cs.GLsizei, _cs.GLint, _cs.GLenum, _cs.GLenum, ctypes.c_void_p
)
...
@_f
@_p.types(
    None, _cs.GLuint, _cs.GLenum, _cs.GLint, _cs.GLint, _cs.GLsizei, _cs.GLint, _cs.GLenum, _cs.GLenum, ctypes.c_void_p
)
...
@_f
@_p.types(
    None, _cs.GLuint, _cs.GLint, _cs.GLint, _cs.GLint, _cs.GLint, _cs.GLsizei, _cs.GLsizei, _cs.GLsizei, _cs.GLboolean
)
...
def glTextureStorage3DMultisampleEXT(
