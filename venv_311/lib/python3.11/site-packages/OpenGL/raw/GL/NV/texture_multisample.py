...
def _f(function):
    return _p.createFunction(
        function, _p.PLATFORM.GL, "GL_NV_texture_multisample", error_checker=_errors._error_checker
    )
...
def glTexImage2DMultisampleCoverageNV(
...
def glTexImage3DMultisampleCoverageNV(
