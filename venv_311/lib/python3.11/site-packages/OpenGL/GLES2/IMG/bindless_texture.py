...
glUniformHandleui64vIMG = wrapper.wrapper(glUniformHandleui64vIMG).setInputArraySize("value", None)
# INPUT glProgramUniformHandleui64vIMG.values size not checked against count
glProgramUniformHandleui64vIMG = wrapper.wrapper(glProgramUniformHandleui64vIMG).setInputArraySize("values", None)
