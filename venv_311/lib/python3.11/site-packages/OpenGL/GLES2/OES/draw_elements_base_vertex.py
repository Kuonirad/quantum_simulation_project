...
glDrawElementsBaseVertexOES = wrapper.wrapper(glDrawElementsBaseVertexOES).setInputArraySize("indices", None)
# INPUT glDrawRangeElementsBaseVertexOES.indices size not checked against 'count,type'
glDrawRangeElementsBaseVertexOES = wrapper.wrapper(glDrawRangeElementsBaseVertexOES).setInputArraySize("indices", None)
