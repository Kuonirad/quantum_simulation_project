...
glDeleteVertexArraysOES = wrapper.wrapper(glDeleteVertexArraysOES).setInputArraySize("arrays", None)
# INPUT glGenVertexArraysOES.arrays size not checked against n
glGenVertexArraysOES = wrapper.wrapper(glGenVertexArraysOES).setInputArraySize("arrays", None)
