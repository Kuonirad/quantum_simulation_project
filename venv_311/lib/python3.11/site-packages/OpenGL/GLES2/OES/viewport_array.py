...
glViewportArrayvOES = wrapper.wrapper(glViewportArrayvOES).setInputArraySize("v", None)
glViewportIndexedfvOES = wrapper.wrapper(glViewportIndexedfvOES).setInputArraySize("v", 4)
# INPUT glScissorArrayvOES.v size not checked against 'count'
glScissorArrayvOES = wrapper.wrapper(glScissorArrayvOES).setInputArraySize("v", None)
glScissorIndexedvOES = wrapper.wrapper(glScissorIndexedvOES).setInputArraySize("v", 4)
# INPUT glGetFloati_vOES.data size not checked against 'target'
glGetFloati_vOES = wrapper.wrapper(glGetFloati_vOES).setInputArraySize("data", None)
