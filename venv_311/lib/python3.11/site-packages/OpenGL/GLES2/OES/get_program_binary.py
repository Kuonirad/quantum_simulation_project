...
glGetProgramBinaryOES = (
    wrapper.wrapper(glGetProgramBinaryOES)
    .setInputArraySize("binary", None)
    .setInputArraySize("binaryFormat", 1)
    .setInputArraySize("length", 1)
)
# INPUT glProgramBinaryOES.binary size not checked against length
glProgramBinaryOES = wrapper.wrapper(glProgramBinaryOES).setInputArraySize("binary", None)
