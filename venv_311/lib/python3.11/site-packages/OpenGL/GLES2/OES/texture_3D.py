...
glTexImage3DOES = wrapper.wrapper(glTexImage3DOES).setInputArraySize("pixels", None)
# INPUT glTexSubImage3DOES.pixels size not checked against 'format,type,width,height,depth'
glTexSubImage3DOES = wrapper.wrapper(glTexSubImage3DOES).setInputArraySize("pixels", None)
# INPUT glCompressedTexImage3DOES.data size not checked against imageSize
glCompressedTexImage3DOES = wrapper.wrapper(glCompressedTexImage3DOES).setInputArraySize("data", None)
# INPUT glCompressedTexSubImage3DOES.data size not checked against imageSize
glCompressedTexSubImage3DOES = wrapper.wrapper(glCompressedTexSubImage3DOES).setInputArraySize("data", None)
