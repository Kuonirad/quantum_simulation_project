...
glTexParameterIivOES = wrapper.wrapper(glTexParameterIivOES).setInputArraySize("params", None)
# INPUT glTexParameterIuivOES.params size not checked against 'pname'
glTexParameterIuivOES = wrapper.wrapper(glTexParameterIuivOES).setInputArraySize("params", None)
# INPUT glGetTexParameterIivOES.params size not checked against 'pname'
glGetTexParameterIivOES = wrapper.wrapper(glGetTexParameterIivOES).setInputArraySize("params", None)
# INPUT glGetTexParameterIuivOES.params size not checked against 'pname'
glGetTexParameterIuivOES = wrapper.wrapper(glGetTexParameterIuivOES).setInputArraySize("params", None)
# INPUT glSamplerParameterIivOES.param size not checked against 'pname'
glSamplerParameterIivOES = wrapper.wrapper(glSamplerParameterIivOES).setInputArraySize("param", None)
# INPUT glSamplerParameterIuivOES.param size not checked against 'pname'
glSamplerParameterIuivOES = wrapper.wrapper(glSamplerParameterIuivOES).setInputArraySize("param", None)
# INPUT glGetSamplerParameterIivOES.params size not checked against 'pname'
glGetSamplerParameterIivOES = wrapper.wrapper(glGetSamplerParameterIivOES).setInputArraySize("params", None)
# INPUT glGetSamplerParameterIuivOES.params size not checked against 'pname'
glGetSamplerParameterIuivOES = wrapper.wrapper(glGetSamplerParameterIuivOES).setInputArraySize("params", None)
