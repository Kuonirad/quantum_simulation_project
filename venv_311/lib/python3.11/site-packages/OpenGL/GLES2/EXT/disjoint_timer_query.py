...
glGenQueriesEXT = wrapper.wrapper(glGenQueriesEXT).setInputArraySize("ids", None)
# INPUT glDeleteQueriesEXT.ids size not checked against n
glDeleteQueriesEXT = wrapper.wrapper(glDeleteQueriesEXT).setInputArraySize("ids", None)
# INPUT glGetQueryivEXT.params size not checked against 'pname'
glGetQueryivEXT = wrapper.wrapper(glGetQueryivEXT).setInputArraySize("params", None)
# INPUT glGetQueryObjectivEXT.params size not checked against 'pname'
glGetQueryObjectivEXT = wrapper.wrapper(glGetQueryObjectivEXT).setInputArraySize("params", None)
# INPUT glGetQueryObjectuivEXT.params size not checked against 'pname'
glGetQueryObjectuivEXT = wrapper.wrapper(glGetQueryObjectuivEXT).setInputArraySize("params", None)
