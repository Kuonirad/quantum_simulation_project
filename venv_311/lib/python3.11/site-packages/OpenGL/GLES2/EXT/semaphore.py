...
glGetUnsignedBytevEXT = wrapper.wrapper(glGetUnsignedBytevEXT).setInputArraySize("data", None)
# INPUT glGetUnsignedBytei_vEXT.data size not checked against 'target'
glGetUnsignedBytei_vEXT = wrapper.wrapper(glGetUnsignedBytei_vEXT).setInputArraySize("data", None)
# INPUT glGenSemaphoresEXT.semaphores size not checked against n
glGenSemaphoresEXT = wrapper.wrapper(glGenSemaphoresEXT).setInputArraySize("semaphores", None)
# INPUT glDeleteSemaphoresEXT.semaphores size not checked against n
glDeleteSemaphoresEXT = wrapper.wrapper(glDeleteSemaphoresEXT).setInputArraySize("semaphores", None)
...
glWaitSemaphoreEXT = (
    wrapper.wrapper(glWaitSemaphoreEXT)
    .setInputArraySize("buffers", None)
    .setInputArraySize("srcLayouts", None)
...
glSignalSemaphoreEXT = (
    wrapper.wrapper(glSignalSemaphoreEXT)
    .setInputArraySize("buffers", None)
    .setInputArraySize("dstLayouts", None)
    .setInputArraySize("textures", None)
)
