...
glDrawElementsBaseVertexEXT = wrapper.wrapper(glDrawElementsBaseVertexEXT).setInputArraySize("indices", None)
# INPUT glDrawRangeElementsBaseVertexEXT.indices size not checked against 'count,type'
glDrawRangeElementsBaseVertexEXT = wrapper.wrapper(glDrawRangeElementsBaseVertexEXT).setInputArraySize("indices", None)
...
glMultiDrawElementsBaseVertexEXT = (
    wrapper.wrapper(glMultiDrawElementsBaseVertexEXT)
