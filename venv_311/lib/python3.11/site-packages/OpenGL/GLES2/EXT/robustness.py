...
glReadnPixelsEXT = wrapper.wrapper(glReadnPixelsEXT).setInputArraySize("data", None)
# INPUT glGetnUniformfvEXT.params size not checked against bufSize
glGetnUniformfvEXT = wrapper.wrapper(glGetnUniformfvEXT).setInputArraySize("params", None)
# INPUT glGetnUniformivEXT.params size not checked against bufSize
glGetnUniformivEXT = wrapper.wrapper(glGetnUniformivEXT).setInputArraySize("params", None)
