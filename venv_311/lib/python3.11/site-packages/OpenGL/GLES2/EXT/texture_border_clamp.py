...
glTexParameterIivEXT = wrapper.wrapper(glTexParameterIivEXT).setInputArraySize("params", None)
# INPUT glTexParameterIuivEXT.params size not checked against 'pname'
glTexParameterIuivEXT = wrapper.wrapper(glTexParameterIuivEXT).setInputArraySize("params", None)
...
glSamplerParameterIivEXT = wrapper.wrapper(glSamplerParameterIivEXT).setInputArraySize("param", None)
# INPUT glSamplerParameterIuivEXT.param size not checked against 'pname'
glSamplerParameterIuivEXT = wrapper.wrapper(glSamplerParameterIuivEXT).setInputArraySize("param", None)
# INPUT glGetSamplerParameterIivEXT.params size not checked against 'pname'
glGetSamplerParameterIivEXT = wrapper.wrapper(glGetSamplerParameterIivEXT).setInputArraySize("params", None)
# INPUT glGetSamplerParameterIuivEXT.params size not checked against 'pname'
glGetSamplerParameterIuivEXT = wrapper.wrapper(glGetSamplerParameterIuivEXT).setInputArraySize("params", None)
