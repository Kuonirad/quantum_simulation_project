...
glClearTexImageEXT = wrapper.wrapper(glClearTexImageEXT).setInputArraySize("data", None)
# INPUT glClearTexSubImageEXT.data size not checked against 'format,type'
glClearTexSubImageEXT = wrapper.wrapper(glClearTexSubImageEXT).setInputArraySize("data", None)
