...
glExtGetBuffersQCOM = (
    wrapper.wrapper(glExtGetBuffersQCOM).setInputArraySize("buffers", None).setInputArraySize("numBuffers", 1)
)
# INPUT glExtGetRenderbuffersQCOM.renderbuffers size not checked against maxRenderbuffers
glExtGetRenderbuffersQCOM = (
    wrapper.wrapper(glExtGetRenderbuffersQCOM)
    .setInputArraySize("numRenderbuffers", 1)
    .setInputArraySize("renderbuffers", None)
)
# INPUT glExtGetFramebuffersQCOM.framebuffers size not checked against maxFramebuffers
glExtGetFramebuffersQCOM = (
    wrapper.wrapper(glExtGetFramebuffersQCOM)
    .setInputArraySize("framebuffers", None)
    .setInputArraySize("numFramebuffers", 1)
)
