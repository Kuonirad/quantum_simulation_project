...
glUniformHandleui64vNV = wrapper.wrapper(glUniformHandleui64vNV).setInputArraySize("value", None)
# INPUT glProgramUniformHandleui64vNV.values size not checked against count
glProgramUniformHandleui64vNV = wrapper.wrapper(glProgramUniformHandleui64vNV).setInputArraySize("values", None)
