...
glPathCommandsNV = (
    wrapper.wrapper(glPathCommandsNV).setInputArraySize("commands", None).setInputArraySize("coords", None)
)
# INPUT glPathCoordsNV.coords size not checked against 'numCoords,coordType'
glPathCoordsNV = wrapper.wrapper(glPathCoordsNV).setInputArraySize("coords", None)
...
glPathSubCommandsNV = (
    wrapper.wrapper(glPathSubCommandsNV).setInputArraySize("commands", None).setInputArraySize("coords", None)
)
# INPUT glPathSubCoordsNV.coords size not checked against 'numCoords,coordType'
glPathSubCoordsNV = wrapper.wrapper(glPathSubCoordsNV).setInputArraySize("coords", None)
# INPUT glPathStringNV.pathString size not checked against length
glPathStringNV = wrapper.wrapper(glPathStringNV).setInputArraySize("pathString", None)
...
glPathGlyphsNV = (
    wrapper.wrapper(glPathGlyphsNV).setInputArraySize("charcodes", None).setInputArraySize("fontName", None)
)
# INPUT glPathGlyphRangeNV.fontName size not checked against 'fontTarget,fontName'
glPathGlyphRangeNV = wrapper.wrapper(glPathGlyphRangeNV).setInputArraySize("fontName", None)
...
glWeightPathsNV = wrapper.wrapper(glWeightPathsNV).setInputArraySize("paths", None).setInputArraySize("weights", None)
# INPUT glTransformPathNV.transformValues size not checked against 'transformType'
glTransformPathNV = wrapper.wrapper(glTransformPathNV).setInputArraySize("transformValues", None)
# INPUT glPathParameterivNV.value size not checked against 'pname'
glPathParameterivNV = wrapper.wrapper(glPathParameterivNV).setInputArraySize("value", None)
# INPUT glPathParameterfvNV.value size not checked against 'pname'
glPathParameterfvNV = wrapper.wrapper(glPathParameterfvNV).setInputArraySize("value", None)
# INPUT glPathDashArrayNV.dashArray size not checked against dashCount
glPathDashArrayNV = wrapper.wrapper(glPathDashArrayNV).setInputArraySize("dashArray", None)
...
glStencilFillPathInstancedNV = (
    wrapper.wrapper(glStencilFillPathInstancedNV)
    .setInputArraySize("paths", None)
    .setInputArraySize("transformValues", None)
)
...
glStencilStrokePathInstancedNV = (
    wrapper.wrapper(glStencilStrokePathInstancedNV)
    .setInputArraySize("paths", None)
    .setInputArraySize("transformValues", None)
)
...
glCoverFillPathInstancedNV = (
    wrapper.wrapper(glCoverFillPathInstancedNV)
    .setInputArraySize("paths", None)
    .setInputArraySize("transformValues", None)
)
...
glCoverStrokePathInstancedNV = (
    wrapper.wrapper(glCoverStrokePathInstancedNV)
    .setInputArraySize("paths", None)
    .setInputArraySize("transformValues", None)
)
glGetPathParameterivNV = wrapper.wrapper(glGetPathParameterivNV).setOutput("value", size=(4,), orPassIn=True)
glGetPathParameterfvNV = wrapper.wrapper(glGetPathParameterfvNV).setOutput("value", size=(4,), orPassIn=True)
...
glGetPathMetricsNV = wrapper.wrapper(glGetPathMetricsNV).setInputArraySize("paths", None)
...
glGetPathSpacingNV = wrapper.wrapper(glGetPathSpacingNV).setInputArraySize("paths", None)
glPointAlongPathNV = (
    wrapper.wrapper(glPointAlongPathNV)
    .setOutput("tangentX", size=(1,), orPassIn=True)
    .setOutput("tangentY", size=(1,), orPassIn=True)
    .setOutput("x", size=(1,), orPassIn=True)
    .setOutput("y", size=(1,), orPassIn=True)
)
# INPUT glPathColorGenNV.coeffs size not checked against 'genMode,colorFormat'
glPathColorGenNV = wrapper.wrapper(glPathColorGenNV).setInputArraySize("coeffs", None)
# INPUT glPathTexGenNV.coeffs size not checked against 'genMode,components'
glPathTexGenNV = wrapper.wrapper(glPathTexGenNV).setInputArraySize("coeffs", None)
