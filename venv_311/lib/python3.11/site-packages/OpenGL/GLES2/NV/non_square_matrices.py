...
glUniformMatrix2x3fvNV = wrapper.wrapper(glUniformMatrix2x3fvNV).setInputArraySize("value", None)
# INPUT glUniformMatrix3x2fvNV.value size not checked against count*6
glUniformMatrix3x2fvNV = wrapper.wrapper(glUniformMatrix3x2fvNV).setInputArraySize("value", None)
# INPUT glUniformMatrix2x4fvNV.value size not checked against count*8
glUniformMatrix2x4fvNV = wrapper.wrapper(glUniformMatrix2x4fvNV).setInputArraySize("value", None)
# INPUT glUniformMatrix4x2fvNV.value size not checked against count*8
glUniformMatrix4x2fvNV = wrapper.wrapper(glUniformMatrix4x2fvNV).setInputArraySize("value", None)
# INPUT glUniformMatrix3x4fvNV.value size not checked against count*12
glUniformMatrix3x4fvNV = wrapper.wrapper(glUniformMatrix3x4fvNV).setInputArraySize("value", None)
# INPUT glUniformMatrix4x3fvNV.value size not checked against count*12
glUniformMatrix4x3fvNV = wrapper.wrapper(glUniformMatrix4x3fvNV).setInputArraySize("value", None)
