...
glViewportArrayvNV = wrapper.wrapper(glViewportArrayvNV).setInputArraySize("v", None)
glViewportIndexedfvNV = wrapper.wrapper(glViewportIndexedfvNV).setInputArraySize("v", 4)
# INPUT glScissorArrayvNV.v size not checked against 'count'
glScissorArrayvNV = wrapper.wrapper(glScissorArrayvNV).setInputArraySize("v", None)
glScissorIndexedvNV = wrapper.wrapper(glScissorIndexedvNV).setInputArraySize("v", 4)
# INPUT glGetFloati_vNV.data size not checked against 'target'
glGetFloati_vNV = wrapper.wrapper(glGetFloati_vNV).setInputArraySize("data", None)
