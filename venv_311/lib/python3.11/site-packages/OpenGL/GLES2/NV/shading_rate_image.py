...
glGetShadingRateImagePaletteNV = wrapper.wrapper(glGetShadingRateImagePaletteNV).setInputArraySize("rate", 1)
...
glShadingRateImagePaletteNV = wrapper.wrapper(glShadingRateImagePaletteNV).setInputArraySize("rates", None)
