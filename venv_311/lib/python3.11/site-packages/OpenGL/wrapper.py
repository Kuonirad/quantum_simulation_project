        ...
        def setInputArraySize(self, argName, size=None):
            ...
            if not hasattr(arrayType, "asArray"):
                if arrayType == ctypes.c_void_p:
                    ...
                    self.setPyConverter(argName, converters.CallFuncPyConverter(arraydatatype.ArrayDatatype.asArray))
    ...
    def finaliseCall(self):
        ...
        if pyConverters:
            if cWrapper:
                ...
                pyConverters_mapped = [
                    (i, converter, (converter is None)) for (i, converter) in enumerate(pyConverters)
                ]
        ...
        if cConverters:
            if cWrapper:
                ...
                cConverters_mapped = [
                    (i, converter, hasattr(converter, "__call__")) for (i, converter) in enumerate(cConverters)
                ]
