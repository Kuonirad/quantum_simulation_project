...
glGetProgramResourceIndex = wrapper.wrapper(glGetProgramResourceIndex).setInputArraySize("name", None)
glGetProgramResourceName = (
    wrapper.wrapper(glGetProgramResourceName)
...
glGetProgramResourceiv = (
    wrapper.wrapper(glGetProgramResourceiv)
    .setOutput("length", size=(1,), orPassIn=True)
    .setOutput("params", size=lambda x: (x,), pnameArg="bufSize", orPassIn=True)
    .setInputArraySize("props", None)
)
# INPUT glGetProgramResourceLocation.name size not checked against 'name'
glGetProgramResourceLocation = wrapper.wrapper(glGetProgramResourceLocation).setInputArraySize("name", None)
