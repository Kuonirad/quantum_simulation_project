...
class GLUtesselator(glustruct.GLUStruct, _simple.GLUtesselator):
    ...
    CALLBACK_TYPES = {
        ...
        _simple.GLU_TESS_BEGIN_DATA: FUNCTION_TYPE(None, _simple.GLenum, ctypes.c_void_p),
        _simple.GLU_TESS_EDGE_FLAG: FUNCTION_TYPE(None, _simple.GLboolean),
        _simple.GLU_TESS_EDGE_FLAG_DATA: FUNCTION_TYPE(None, _simple.GLboolean, ctypes.c_void_p),
        _simple.GLU_TESS_VERTEX: FUNCTION_TYPE(None, ctypes.c_void_p),
        _simple.GLU_TESS_VERTEX_DATA: FUNCTION_TYPE(None, ctypes.c_void_p, ctypes.c_void_p),
        ...
        _simple.GLU_TESS_ERROR_DATA: FUNCTION_TYPE(None, _simple.GLenum, ctypes.c_void_p),
