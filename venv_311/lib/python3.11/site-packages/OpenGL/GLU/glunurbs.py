...
class GLUnurbs(glustruct.GLUStruct, _simple.GLUnurbs):
    ...
    CALLBACK_TYPES = {
        ...
        _simple.GLU_NURBS_BEGIN: FUNCTION_TYPE(None, _simple.GLenum),
        _simple.GLU_NURBS_BEGIN_DATA: FUNCTION_TYPE(None, _simple.GLenum, ctypes.POINTER(_simple.GLvoid)),
        _simple.GLU_NURBS_VERTEX: FUNCTION_TYPE(None, ctypes.POINTER(_simple.GLfloat)),
        _simple.GLU_NURBS_VERTEX_DATA: FUNCTION_TYPE(
            None, ctypes.POINTER(_simple.GLfloat), ctypes.POINTER(_simple.GLvoid)
        ),
        _simple.GLU_NURBS_NORMAL: FUNCTION_TYPE(None, ctypes.POINTER(_simple.GLfloat)),
        _simple.GLU_NURBS_NORMAL_DATA: FUNCTION_TYPE(
            None, ctypes.POINTER(_simple.GLfloat), ctypes.POINTER(_simple.GLvoid)
        ),
        _simple.GLU_NURBS_COLOR: FUNCTION_TYPE(None, ctypes.POINTER(_simple.GLfloat)),
        _simple.GLU_NURBS_COLOR_DATA: FUNCTION_TYPE(
            None, ctypes.POINTER(_simple.GLfloat), ctypes.POINTER(_simple.GLvoid)
        ),
        _simple.GLU_NURBS_TEXTURE_COORD: FUNCTION_TYPE(None, ctypes.POINTER(_simple.GLfloat)),
        _simple.GLU_NURBS_TEXTURE_COORD_DATA: FUNCTION_TYPE(
            None, ctypes.POINTER(_simple.GLfloat), ctypes.POINTER(_simple.GLvoid)
        ),
        _simple.GLU_NURBS_END: FUNCTION_TYPE(None),
        _simple.GLU_NURBS_END_DATA: FUNCTION_TYPE(None, ctypes.POINTER(_simple.GLvoid)),
...
def checkOrder(order, knotCount, name):
    ...
    if order < 1:
        ...
        raise error.GLUError("""%s should be %s or less, is %s""" % (name, MAX_ORDER, order))
