...
class Win32Platform(baseplatform.BasePlatform):
    ...
    def GL(self):
        try:
            return ctypesloader.loadLibrary(ctypes.windll, "opengl32", mode=ctypes.RTLD_GLOBAL)
    ...
    def GLU(self):
        try:
            return ctypesloader.loadLibrary(ctypes.windll, "glu32", mode=ctypes.RTLD_GLOBAL)
        except OSError:
            return None
