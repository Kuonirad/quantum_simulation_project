...
glTexGenfvOES = wrapper.wrapper(glTexGenfvOES).setInputArraySize("params", None)
# INPUT glTexGenivOES.params size not checked against 'pname'
glTexGenivOES = wrapper.wrapper(glTexGenivOES).setInputArraySize("params", None)
...
glGetTexGenfvOES = wrapper.wrapper(glGetTexGenfvOES).setInputArraySize("params", None)
# INPUT glGetTexGenivOES.params size not checked against 'pname'
glGetTexGenivOES = wrapper.wrapper(glGetTexGenivOES).setInputArraySize("params", None)
