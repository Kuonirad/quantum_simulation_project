...
glMatrixIndexPointerOES = wrapper.wrapper(glMatrixIndexPointerOES).setInputArraySize("pointer", None)
# INPUT glWeightPointerOES.pointer size not checked against 'type,stride'
glWeightPointerOES = wrapper.wrapper(glWeightPointerOES).setInputArraySize("pointer", None)
