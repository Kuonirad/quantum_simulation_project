...
glDrawTexsvOES = wrapper.wrapper(glDrawTexsvOES).setInputArraySize("coords", 5)
glDrawTexivOES = wrapper.wrapper(glDrawTexivOES).setInputArraySize("coords", 5)
glDrawTexxvOES = wrapper.wrapper(glDrawTexxvOES).setInputArraySize("coords", 5)
glDrawTexfvOES = wrapper.wrapper(glDrawTexfvOES).setInputArraySize("coords", 5)
