...
glDeleteRenderbuffersOES = wrapper.wrapper(glDeleteRenderbuffersOES).setInputArraySize("renderbuffers", None)
# INPUT glGenRenderbuffersOES.renderbuffers size not checked against n
glGenRenderbuffersOES = wrapper.wrapper(glGenRenderbuffersOES).setInputArraySize("renderbuffers", None)
# INPUT glGetRenderbufferParameterivOES.params size not checked against 'pname'
glGetRenderbufferParameterivOES = wrapper.wrapper(glGetRenderbufferParameterivOES).setInputArraySize("params", None)
# INPUT glDeleteFramebuffersOES.framebuffers size not checked against n
glDeleteFramebuffersOES = wrapper.wrapper(glDeleteFramebuffersOES).setInputArraySize("framebuffers", None)
# INPUT glGenFramebuffersOES.framebuffers size not checked against n
glGenFramebuffersOES = wrapper.wrapper(glGenFramebuffersOES).setInputArraySize("framebuffers", None)
