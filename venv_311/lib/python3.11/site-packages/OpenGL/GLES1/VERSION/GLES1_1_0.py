...
glClipPlanef = wrapper.wrapper(glClipPlanef).setInputArraySize("eqn", 4)
# INPUT glFogfv.params size not checked against 'pname'
glFogfv = wrapper.wrapper(glFogfv).setInputArraySize("params", None)
glGetClipPlanef = wrapper.wrapper(glGetClipPlanef).setInputArraySize("equation", 4)
...
glPointParameterfv = wrapper.wrapper(glPointParameterfv).setInputArraySize("params", None)
...
glClipPlanex = wrapper.wrapper(glClipPlanex).setInputArraySize("equation", 4)
# INPUT glColorPointer.pointer size not checked against 'size,type,stride'
glColorPointer = wrapper.wrapper(glColorPointer).setInputArraySize("pointer", None)
# INPUT glCompressedTexImage2D.data size not checked against imageSize
glCompressedTexImage2D = wrapper.wrapper(glCompressedTexImage2D).setInputArraySize("data", None)
# INPUT glCompressedTexSubImage2D.data size not checked against imageSize
glCompressedTexSubImage2D = wrapper.wrapper(glCompressedTexSubImage2D).setInputArraySize("data", None)
...
glFogxv = wrapper.wrapper(glFogxv).setInputArraySize("param", None)
...
glGetClipPlanex = wrapper.wrapper(glGetClipPlanex).setInputArraySize("equation", 4)
glGenBuffers = wrapper.wrapper(glGenBuffers).setOutput("buffers", size=lambda x: (x,), pnameArg="n", orPassIn=True)
glGenTextures = wrapper.wrapper(glGenTextures).setOutput("textures", size=lambda x: (x,), pnameArg="n", orPassIn=True)
glGetIntegerv = wrapper.wrapper(glGetIntegerv).setOutput(
    "data", size=_glgets._glget_size_mapping, pnameArg="pname", orPassIn=True
)
# INPUT glGetLightxv.params size not checked against 'pname'
glGetLightxv = wrapper.wrapper(glGetLightxv).setInputArraySize("params", None)
# INPUT glGetMaterialxv.params size not checked against 'pname'
glGetMaterialxv = wrapper.wrapper(glGetMaterialxv).setInputArraySize("params", None)
glGetPointerv = wrapper.wrapper(glGetPointerv).setOutput("params", size=(1,), orPassIn=True)
glGetTexEnviv = wrapper.wrapper(glGetTexEnviv).setOutput(
    "params", size=_glgets._glget_size_mapping, pnameArg="pname", orPassIn=True
)
# INPUT glGetTexEnvxv.params size not checked against 'pname'
glGetTexEnvxv = wrapper.wrapper(glGetTexEnvxv).setInputArraySize("params", None)
...
glGetTexParameterxv = wrapper.wrapper(glGetTexParameterxv).setInputArraySize("params", None)
# INPUT glLightModelxv.param size not checked against 'pname'
glLightModelxv = wrapper.wrapper(glLightModelxv).setInputArraySize("param", None)
# INPUT glLightxv.params size not checked against 'pname'
glLightxv = wrapper.wrapper(glLightxv).setInputArraySize("params", None)
glLoadMatrixx = wrapper.wrapper(glLoadMatrixx).setInputArraySize("m", 16)
# INPUT glMaterialxv.param size not checked against 'pname'
glMaterialxv = wrapper.wrapper(glMaterialxv).setInputArraySize("param", None)
glMultMatrixx = wrapper.wrapper(glMultMatrixx).setInputArraySize("m", 16)
# INPUT glNormalPointer.pointer size not checked against 'type,stride'
glNormalPointer = wrapper.wrapper(glNormalPointer).setInputArraySize("pointer", None)
# INPUT glPointParameterxv.params size not checked against 'pname'
glPointParameterxv = wrapper.wrapper(glPointParameterxv).setInputArraySize("params", None)
...
glTexCoordPointer = wrapper.wrapper(glTexCoordPointer).setInputArraySize("pointer", None)
...
glTexEnvxv = wrapper.wrapper(glTexEnvxv).setInputArraySize("params", None)
...
glTexParameterxv = wrapper.wrapper(glTexParameterxv).setInputArraySize("params", None)
...
glVertexPointer = wrapper.wrapper(glVertexPointer).setInputArraySize("pointer", None)
