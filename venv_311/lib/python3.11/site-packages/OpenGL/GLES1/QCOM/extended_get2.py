...
glExtGetShadersQCOM = (
    wrapper.wrapper(glExtGetShadersQCOM).setInputArraySize("numShaders", 1).setInputArraySize("shaders", None)
)
# INPUT glExtGetProgramsQCOM.programs size not checked against maxPrograms
glExtGetProgramsQCOM = (
    wrapper.wrapper(glExtGetProgramsQCOM).setInputArraySize("numPrograms", 1).setInputArraySize("programs", None)
)
