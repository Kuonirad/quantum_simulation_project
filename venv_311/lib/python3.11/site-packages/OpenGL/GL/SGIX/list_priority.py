...
glListParameterfvSGIX = wrapper.wrapper(glListParameterfvSGIX).setInputArraySize("params", None)
# INPUT glListParameterivSGIX.params size not checked against 'pname'
glListParameterivSGIX = wrapper.wrapper(glListParameterivSGIX).setInputArraySize("params", None)
