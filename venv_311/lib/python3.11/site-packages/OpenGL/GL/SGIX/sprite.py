...
glSpriteParameterfvSGIX = wrapper.wrapper(glSpriteParameterfvSGIX).setInputArraySize("params", None)
# INPUT glSpriteParameterivSGIX.params size not checked against 'pname'
glSpriteParameterivSGIX = wrapper.wrapper(glSpriteParameterivSGIX).setInputArraySize("params", None)
