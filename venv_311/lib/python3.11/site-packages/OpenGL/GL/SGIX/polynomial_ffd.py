...
glDeformationMap3dSGIX = wrapper.wrapper(glDeformationMap3dSGIX).setInputArraySize("points", None)
# INPUT glDeformationMap3fSGIX.points size not checked against 'target,ustride,uorder,vstride,vorder,wstride,worder'
glDeformationMap3fSGIX = wrapper.wrapper(glDeformationMap3fSGIX).setInputArraySize("points", None)
