...
glFragmentLightfvSGIX = wrapper.wrapper(glFragmentLightfvSGIX).setInputArraySize("params", None)
# INPUT glFragmentLightivSGIX.params size not checked against 'pname'
glFragmentLightivSGIX = wrapper.wrapper(glFragmentLightivSGIX).setInputArraySize("params", None)
# INPUT glFragmentLightModelfvSGIX.params size not checked against 'pname'
glFragmentLightModelfvSGIX = wrapper.wrapper(glFragmentLightModelfvSGIX).setInputArraySize("params", None)
# INPUT glFragmentLightModelivSGIX.params size not checked against 'pname'
glFragmentLightModelivSGIX = wrapper.wrapper(glFragmentLightModelivSGIX).setInputArraySize("params", None)
# INPUT glFragmentMaterialfvSGIX.params size not checked against 'pname'
glFragmentMaterialfvSGIX = wrapper.wrapper(glFragmentMaterialfvSGIX).setInputArraySize("params", None)
# INPUT glFragmentMaterialivSGIX.params size not checked against 'pname'
glFragmentMaterialivSGIX = wrapper.wrapper(glFragmentMaterialivSGIX).setInputArraySize("params", None)
