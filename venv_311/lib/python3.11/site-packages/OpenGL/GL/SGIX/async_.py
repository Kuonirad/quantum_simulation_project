...
glFinishAsyncSGIX = wrapper.wrapper(glFinishAsyncSGIX).setOutput("markerp", size=(1,), orPassIn=True)
glPollAsyncSGIX = wrapper.wrapper(glPollAsyncSGIX).setOutput("markerp", size=(1,), orPassIn=True)
