...
glReplacementCodeuivSUN = wrapper.wrapper(glReplacementCodeuivSUN).setInputArraySize("code", None)
# INPUT glReplacementCodeusvSUN.code size not checked against ''
glReplacementCodeusvSUN = wrapper.wrapper(glReplacementCodeusvSUN).setInputArraySize("code", None)
# INPUT glReplacementCodeubvSUN.code size not checked against ''
glReplacementCodeubvSUN = wrapper.wrapper(glReplacementCodeubvSUN).setInputArraySize("code", None)
# INPUT glReplacementCodePointerSUN.pointer size not checked against 'type,stride'
glReplacementCodePointerSUN = wrapper.wrapper(glReplacementCodePointerSUN).setInputArraySize("pointer", None)
