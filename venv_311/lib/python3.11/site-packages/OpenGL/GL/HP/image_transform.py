...
glImageTransformParameterivHP = wrapper.wrapper(glImageTransformParameterivHP).setInputArraySize("params", None)
# INPUT glImageTransformParameterfvHP.params size not checked against 'pname'
glImageTransformParameterfvHP = wrapper.wrapper(glImageTransformParameterfvHP).setInputArraySize("params", None)
