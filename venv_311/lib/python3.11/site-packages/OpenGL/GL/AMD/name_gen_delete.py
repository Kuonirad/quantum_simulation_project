...
glGenNamesAMD = wrapper.wrapper(glGenNamesAMD).setOutput("names", size=lambda x: (x,), pnameArg="num", orPassIn=True)
# INPUT glDeleteNamesAMD.names size not checked against num
glDeleteNamesAMD = wrapper.wrapper(glDeleteNamesAMD).setInputArraySize("names", None)
