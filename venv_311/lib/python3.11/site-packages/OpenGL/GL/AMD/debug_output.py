...
glDebugMessageEnableAMD = wrapper.wrapper(glDebugMessageEnableAMD).setInputArraySize("ids", None)
# INPUT glDebugMessageInsertAMD.buf size not checked against length
glDebugMessageInsertAMD = wrapper.wrapper(glDebugMessageInsertAMD).setInputArraySize("buf", None)
# glDebugMessageCallbackAMD.userParam is OUTPUT without known output size
glGetDebugMessageLogAMD = (
    wrapper.wrapper(glGetDebugMessageLogAMD)
    .setOutput("categories", size=lambda x: (x,), pnameArg="count", orPassIn=True)
    .setOutput("ids", size=lambda x: (x,), pnameArg="count", orPassIn=True)
    .setOutput("lengths", size=lambda x: (x,), pnameArg="count", orPassIn=True)
    .setOutput("message", size=lambda x: (x,), pnameArg="bufsize", orPassIn=True)
