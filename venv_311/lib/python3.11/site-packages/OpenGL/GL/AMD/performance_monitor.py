...
glGetPerfMonitorGroupsAMD = (
    wrapper.wrapper(glGetPerfMonitorGroupsAMD)
    .setOutput("groups", size=lambda x: (x,), pnameArg="groupsSize", orPassIn=True)
    .setOutput("numGroups", size=(1,), orPassIn=True)
)
glGetPerfMonitorCountersAMD = (
    wrapper.wrapper(glGetPerfMonitorCountersAMD)
    .setOutput("counters", size=lambda x: (x,), pnameArg="counterSize", orPassIn=True)
    .setOutput("maxActiveCounters", size=(1,), orPassIn=True)
    .setOutput("numCounters", size=(1,), orPassIn=True)
)
glGetPerfMonitorGroupStringAMD = (
    wrapper.wrapper(glGetPerfMonitorGroupStringAMD)
    .setOutput("groupString", size=lambda x: (x,), pnameArg="bufSize", orPassIn=True)
    .setOutput("length", size=(1,), orPassIn=True)
)
glGetPerfMonitorCounterStringAMD = (
    wrapper.wrapper(glGetPerfMonitorCounterStringAMD)
    .setOutput("counterString", size=lambda x: (x,), pnameArg="bufSize", orPassIn=True)
    .setOutput("length", size=(1,), orPassIn=True)
)
...
glGetPerfMonitorCounterDataAMD = (
    wrapper.wrapper(glGetPerfMonitorCounterDataAMD)
    .setOutput("bytesWritten", size=(1,), orPassIn=True)
    .setOutput("data", size=lambda x: (x,), pnameArg="dataSize", orPassIn=True)
)
