...
glReadnPixelsKHR = wrapper.wrapper(glReadnPixelsKHR).setInputArraySize("data", None)
# INPUT glGetnUniformfvKHR.params size not checked against bufSize
glGetnUniformfvKHR = wrapper.wrapper(glGetnUniformfvKHR).setInputArraySize("params", None)
# INPUT glGetnUniformivKHR.params size not checked against bufSize
glGetnUniformivKHR = wrapper.wrapper(glGetnUniformivKHR).setInputArraySize("params", None)
# INPUT glGetnUniformuivKHR.params size not checked against bufSize
glGetnUniformuivKHR = wrapper.wrapper(glGetnUniformuivKHR).setInputArraySize("params", None)
