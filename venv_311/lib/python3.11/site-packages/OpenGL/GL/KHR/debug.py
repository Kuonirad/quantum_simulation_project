...
glGetDebugMessageLogKHR = (
    wrapper.wrapper(glGetDebugMessageLogKHR)
    .setInputArraySize("ids", None)
    .setInputArraySize("lengths", None)
    .setInputArraySize("messageLog", None)
    .setInputArraySize("severities", None)
    .setInputArraySize("sources", None)
    .setInputArraySize("types", None)
)
# INPUT glGetObjectLabelKHR.label size not checked against bufSize
glGetObjectLabelKHR = wrapper.wrapper(glGetObjectLabelKHR).setInputArraySize("label", None)
# INPUT glGetObjectPtrLabelKHR.label size not checked against bufSize
glGetObjectPtrLabelKHR = (
    wrapper.wrapper(glGetObjectPtrLabelKHR).setInputArraySize("label", None).setInputArraySize("length", 1)
)
