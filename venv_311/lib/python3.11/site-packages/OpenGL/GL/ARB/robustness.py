...
glGetnMapdvARB = wrapper.wrapper(glGetnMapdvARB).setOutput("v", size=lambda x: (x,), pnameArg="bufSize", orPassIn=True)
glGetnMapfvARB = wrapper.wrapper(glGetnMapfvARB).setOutput("v", size=lambda x: (x,), pnameArg="bufSize", orPassIn=True)
glGetnMapivARB = wrapper.wrapper(glGetnMapivARB).setOutput("v", size=lambda x: (x,), pnameArg="bufSize", orPassIn=True)
...
glGetnSeparableFilterARB = (
    ...
    .setOutput("column", size=lambda x: (x,), pnameArg="columnBufSize", orPassIn=True)
    .setOutput("row", size=lambda x: (x,), pnameArg="rowBufSize", orPassIn=True)
    .setOutput("span", size=(0,), orPassIn=True)
)
