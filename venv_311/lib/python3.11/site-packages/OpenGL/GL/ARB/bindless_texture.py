...
glUniformHandleui64vARB = wrapper.wrapper(glUniformHandleui64vARB).setInputArraySize("value", None)
# INPUT glProgramUniformHandleui64vARB.values size not checked against count
glProgramUniformHandleui64vARB = wrapper.wrapper(glProgramUniformHandleui64vARB).setInputArraySize("values", None)
