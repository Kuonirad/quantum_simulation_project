...
glShaderSourceARB = (
    wrapper.wrapper(glShaderSourceARB).setInputArraySize("length", None).setInputArraySize("string", None)
)
...
glUniformMatrix2fvARB = wrapper.wrapper(glUniformMatrix2fvARB).setInputArraySize("value", None)
# INPUT glUniformMatrix3fvARB.value size not checked against count*9
glUniformMatrix3fvARB = wrapper.wrapper(glUniformMatrix3fvARB).setInputArraySize("value", None)
# INPUT glUniformMatrix4fvARB.value size not checked against count*16
glUniformMatrix4fvARB = wrapper.wrapper(glUniformMatrix4fvARB).setInputArraySize("value", None)
