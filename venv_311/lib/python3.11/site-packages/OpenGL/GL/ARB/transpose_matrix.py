...
glLoadTransposeMatrixfARB = wrapper.wrapper(glLoadTransposeMatrixfARB).setInputArraySize("m", 16)
glLoadTransposeMatrixdARB = wrapper.wrapper(glLoadTransposeMatrixdARB).setInputArraySize("m", 16)
glMultTransposeMatrixfARB = wrapper.wrapper(glMultTransposeMatrixfARB).setInputArraySize("m", 16)
glMultTransposeMatrixdARB = wrapper.wrapper(glMultTransposeMatrixdARB).setInputArraySize("m", 16)
