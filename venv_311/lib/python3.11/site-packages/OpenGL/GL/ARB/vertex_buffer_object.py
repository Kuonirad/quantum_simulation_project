...
glDeleteBuffersARB = wrapper.wrapper(glDeleteBuffersARB).setInputArraySize("buffers", None)
...
glBufferDataARB = wrapper.wrapper(glBufferDataARB).setInputArraySize("data", None)
# INPUT glBufferSubDataARB.data size not checked against size
glBufferSubDataARB = wrapper.wrapper(glBufferSubDataARB).setInputArraySize("data", None)
...
glGetBufferPointervARB = wrapper.wrapper(glGetBufferPointervARB).setOutput("params", size=(1,), orPassIn=True)
