...
glNamedStringARB = wrapper.wrapper(glNamedStringARB).setInputArraySize("name", None).setInputArraySize("string", None)
# INPUT glDeleteNamedStringARB.name size not checked against namelen
glDeleteNamedStringARB = wrapper.wrapper(glDeleteNamedStringARB).setInputArraySize("name", None)
...
glCompileShaderIncludeARB = (
    wrapper.wrapper(glCompileShaderIncludeARB).setInputArraySize("length", None).setInputArraySize("path", None)
)
# INPUT glIsNamedStringARB.name size not checked against namelen
glIsNamedStringARB = wrapper.wrapper(glIsNamedStringARB).setInputArraySize("name", None)
# INPUT glGetNamedStringARB.name size not checked against namelen
glGetNamedStringARB = (
    wrapper.wrapper(glGetNamedStringARB)
    .setInputArraySize("name", None)
    .setOutput("string", size=lambda x: (x,), pnameArg="bufSize", orPassIn=True)
    .setOutput("stringlen", size=(1,), orPassIn=True)
)
# INPUT glGetNamedStringivARB.name size not checked against namelen
glGetNamedStringivARB = (
    wrapper.wrapper(glGetNamedStringivARB)
    .setInputArraySize("name", None)
