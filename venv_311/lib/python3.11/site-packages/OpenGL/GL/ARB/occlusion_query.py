...
glGenQueriesARB = wrapper.wrapper(glGenQueriesARB).setOutput("ids", size=lambda x: (x,), pnameArg="n", orPassIn=True)
# INPUT glDeleteQueriesARB.ids size not checked against n
glDeleteQueriesARB = wrapper.wrapper(glDeleteQueriesARB).setInputArraySize("ids", None)
