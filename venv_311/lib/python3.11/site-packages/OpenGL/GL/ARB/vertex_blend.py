...
glWeightbvARB = wrapper.wrapper(glWeightbvARB).setInputArraySize("weights", None)
# INPUT glWeightsvARB.weights size not checked against size
glWeightsvARB = wrapper.wrapper(glWeightsvARB).setInputArraySize("weights", None)
# INPUT glWeightivARB.weights size not checked against size
glWeightivARB = wrapper.wrapper(glWeightivARB).setInputArraySize("weights", None)
# INPUT glWeightfvARB.weights size not checked against size
glWeightfvARB = wrapper.wrapper(glWeightfvARB).setInputArraySize("weights", None)
# INPUT glWeightdvARB.weights size not checked against size
glWeightdvARB = wrapper.wrapper(glWeightdvARB).setInputArraySize("weights", None)
# INPUT glWeightubvARB.weights size not checked against size
glWeightubvARB = wrapper.wrapper(glWeightubvARB).setInputArraySize("weights", None)
# INPUT glWeightusvARB.weights size not checked against size
glWeightusvARB = wrapper.wrapper(glWeightusvARB).setInputArraySize("weights", None)
# INPUT glWeightuivARB.weights size not checked against size
glWeightuivARB = wrapper.wrapper(glWeightuivARB).setInputArraySize("weights", None)
# INPUT glWeightPointerARB.pointer size not checked against 'type,stride'
glWeightPointerARB = wrapper.wrapper(glWeightPointerARB).setInputArraySize("pointer", None)
