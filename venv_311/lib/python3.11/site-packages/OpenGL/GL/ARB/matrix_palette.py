...
glMatrixIndexubvARB = wrapper.wrapper(glMatrixIndexubvARB).setInputArraySize("indices", None)
# INPUT glMatrixIndexusvARB.indices size not checked against size
glMatrixIndexusvARB = wrapper.wrapper(glMatrixIndexusvARB).setInputArraySize("indices", None)
# INPUT glMatrixIndexuivARB.indices size not checked against size
glMatrixIndexuivARB = wrapper.wrapper(glMatrixIndexuivARB).setInputArraySize("indices", None)
# INPUT glMatrixIndexPointerARB.pointer size not checked against 'size,type,stride'
glMatrixIndexPointerARB = wrapper.wrapper(glMatrixIndexPointerARB).setInputArraySize("pointer", None)
