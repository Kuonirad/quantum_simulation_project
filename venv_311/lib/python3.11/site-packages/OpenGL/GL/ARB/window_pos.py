...
glWindowPos2dvARB = wrapper.wrapper(glWindowPos2dvARB).setInputArraySize("v", 2)
glWindowPos2fvARB = wrapper.wrapper(glWindowPos2fvARB).setInputArraySize("v", 2)
glWindowPos2ivARB = wrapper.wrapper(glWindowPos2ivARB).setInputArraySize("v", 2)
glWindowPos2svARB = wrapper.wrapper(glWindowPos2svARB).setInputArraySize("v", 2)
glWindowPos3dvARB = wrapper.wrapper(glWindowPos3dvARB).setInputArraySize("v", 3)
glWindowPos3fvARB = wrapper.wrapper(glWindowPos3fvARB).setInputArraySize("v", 3)
glWindowPos3ivARB = wrapper.wrapper(glWindowPos3ivARB).setInputArraySize("v", 3)
glWindowPos3svARB = wrapper.wrapper(glWindowPos3svARB).setInputArraySize("v", 3)
