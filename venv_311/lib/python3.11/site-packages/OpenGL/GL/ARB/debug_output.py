...
glDebugMessageControlARB = wrapper.wrapper(glDebugMessageControlARB).setInputArraySize("ids", None)
# INPUT glDebugMessageInsertARB.buf size not checked against length
glDebugMessageInsertARB = wrapper.wrapper(glDebugMessageInsertARB).setInputArraySize("buf", None)
# INPUT glDebugMessageCallbackARB.userParam size not checked against 'callback'
glDebugMessageCallbackARB = wrapper.wrapper(glDebugMessageCallbackARB).setInputArraySize("userParam", None)
glGetDebugMessageLogARB = (
    wrapper.wrapper(glGetDebugMessageLogARB)
