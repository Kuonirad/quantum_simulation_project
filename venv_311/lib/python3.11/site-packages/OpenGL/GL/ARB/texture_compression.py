...
glCompressedTexImage3DARB = wrapper.wrapper(glCompressedTexImage3DARB).setInputArraySize("data", None)
# INPUT glCompressedTexImage2DARB.data size not checked against imageSize
glCompressedTexImage2DARB = wrapper.wrapper(glCompressedTexImage2DARB).setInputArraySize("data", None)
# INPUT glCompressedTexImage1DARB.data size not checked against imageSize
glCompressedTexImage1DARB = wrapper.wrapper(glCompressedTexImage1DARB).setInputArraySize("data", None)
# INPUT glCompressedTexSubImage3DARB.data size not checked against imageSize
glCompressedTexSubImage3DARB = wrapper.wrapper(glCompressedTexSubImage3DARB).setInputArraySize("data", None)
# INPUT glCompressedTexSubImage2DARB.data size not checked against imageSize
glCompressedTexSubImage2DARB = wrapper.wrapper(glCompressedTexSubImage2DARB).setInputArraySize("data", None)
# INPUT glCompressedTexSubImage1DARB.data size not checked against imageSize
glCompressedTexSubImage1DARB = wrapper.wrapper(glCompressedTexSubImage1DARB).setInputArraySize("data", None)
