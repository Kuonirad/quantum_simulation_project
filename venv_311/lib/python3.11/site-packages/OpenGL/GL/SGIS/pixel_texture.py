...
glPixelTexGenParameterivSGIS = wrapper.wrapper(glPixelTexGenParameterivSGIS).setInputArraySize("params", None)
# INPUT glPixelTexGenParameterfvSGIS.params size not checked against 'pname'
glPixelTexGenParameterfvSGIS = wrapper.wrapper(glPixelTexGenParameterfvSGIS).setInputArraySize("params", None)
