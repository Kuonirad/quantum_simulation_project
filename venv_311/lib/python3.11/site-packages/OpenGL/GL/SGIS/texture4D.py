...
glTexImage4DSGIS = wrapper.wrapper(glTexImage4DSGIS).setInputArraySize("pixels", None)
# INPUT glTexSubImage4DSGIS.pixels size not checked against 'format,type,width,height,depth,size4d'
glTexSubImage4DSGIS = wrapper.wrapper(glTexSubImage4DSGIS).setInputArraySize("pixels", None)
