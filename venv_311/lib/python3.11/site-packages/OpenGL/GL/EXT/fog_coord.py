...
glFogCoordfvEXT = wrapper.wrapper(glFogCoordfvEXT).setInputArraySize("coord", 1)
glFogCoorddvEXT = wrapper.wrapper(glFogCoorddvEXT).setInputArraySize("coord", 1)
# INPUT glFogCoordPointerEXT.pointer size not checked against 'type,stride'
glFogCoordPointerEXT = wrapper.wrapper(glFogCoordPointerEXT).setInputArraySize("pointer", None)
