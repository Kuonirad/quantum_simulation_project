...
glVertexAttribL1dvEXT = wrapper.wrapper(glVertexAttribL1dvEXT).setInputArraySize("v", 1)
glVertexAttribL2dvEXT = wrapper.wrapper(glVertexAttribL2dvEXT).setInputArraySize("v", 2)
glVertexAttribL3dvEXT = wrapper.wrapper(glVertexAttribL3dvEXT).setInputArraySize("v", 3)
glVertexAttribL4dvEXT = wrapper.wrapper(glVertexAttribL4dvEXT).setInputArraySize("v", 4)
# INPUT glVertexAttribLPointerEXT.pointer size not checked against size
glVertexAttribLPointerEXT = wrapper.wrapper(glVertexAttribLPointerEXT).setInputArraySize("pointer", None)
