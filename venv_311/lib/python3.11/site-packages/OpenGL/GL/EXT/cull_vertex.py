...
glCullParameterdvEXT = wrapper.wrapper(glCullParameterdvEXT).setOutput("params", size=(4,), orPassIn=True)
glCullParameterfvEXT = wrapper.wrapper(glCullParameterfvEXT).setOutput("params", size=(4,), orPassIn=True)
