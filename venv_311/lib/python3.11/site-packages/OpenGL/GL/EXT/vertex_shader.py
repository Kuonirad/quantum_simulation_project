...
glSetInvariantEXT = wrapper.wrapper(glSetInvariantEXT).setInputArraySize("addr", None)
# INPUT glSetLocalConstantEXT.addr size not checked against 'id,type'
glSetLocalConstantEXT = wrapper.wrapper(glSetLocalConstantEXT).setInputArraySize("addr", None)
# INPUT glVariantbvEXT.addr size not checked against 'id'
glVariantbvEXT = wrapper.wrapper(glVariantbvEXT).setInputArraySize("addr", None)
# INPUT glVariantsvEXT.addr size not checked against 'id'
glVariantsvEXT = wrapper.wrapper(glVariantsvEXT).setInputArraySize("addr", None)
# INPUT glVariantivEXT.addr size not checked against 'id'
glVariantivEXT = wrapper.wrapper(glVariantivEXT).setInputArraySize("addr", None)
# INPUT glVariantfvEXT.addr size not checked against 'id'
glVariantfvEXT = wrapper.wrapper(glVariantfvEXT).setInputArraySize("addr", None)
# INPUT glVariantdvEXT.addr size not checked against 'id'
glVariantdvEXT = wrapper.wrapper(glVariantdvEXT).setInputArraySize("addr", None)
# INPUT glVariantubvEXT.addr size not checked against 'id'
glVariantubvEXT = wrapper.wrapper(glVariantubvEXT).setInputArraySize("addr", None)
# INPUT glVariantusvEXT.addr size not checked against 'id'
glVariantusvEXT = wrapper.wrapper(glVariantusvEXT).setInputArraySize("addr", None)
# INPUT glVariantuivEXT.addr size not checked against 'id'
glVariantuivEXT = wrapper.wrapper(glVariantuivEXT).setInputArraySize("addr", None)
# INPUT glVariantPointerEXT.addr size not checked against 'id,type,stride'
glVariantPointerEXT = wrapper.wrapper(glVariantPointerEXT).setInputArraySize("addr", None)
