...
glConvolutionFilter1DEXT = wrapper.wrapper(glConvolutionFilter1DEXT).setInputArraySize("image", None)
# INPUT glConvolutionFilter2DEXT.image size not checked against 'format,type,width,height'
glConvolutionFilter2DEXT = wrapper.wrapper(glConvolutionFilter2DEXT).setInputArraySize("image", None)
# INPUT glConvolutionParameterfvEXT.params size not checked against 'pname'
glConvolutionParameterfvEXT = wrapper.wrapper(glConvolutionParameterfvEXT).setInputArraySize("params", None)
# INPUT glConvolutionParameterivEXT.params size not checked against 'pname'
glConvolutionParameterivEXT = wrapper.wrapper(glConvolutionParameterivEXT).setInputArraySize("params", None)
...
glSeparableFilter2DEXT = (
    wrapper.wrapper(glSeparableFilter2DEXT).setInputArraySize("column", None).setInputArraySize("row", None)
)
