...
glDeleteRenderbuffersEXT = wrapper.wrapper(glDeleteRenderbuffersEXT).setInputArraySize("renderbuffers", None)
...
glDeleteFramebuffersEXT = wrapper.wrapper(glDeleteFramebuffersEXT).setInputArraySize("framebuffers", None)
