...
glTransformFeedbackVaryingsEXT = wrapper.wrapper(glTransformFeedbackVaryingsEXT).setInputArraySize("varyings", None)
glGetTransformFeedbackVaryingEXT = (
    wrapper.wrapper(glGetTransformFeedbackVaryingEXT)
