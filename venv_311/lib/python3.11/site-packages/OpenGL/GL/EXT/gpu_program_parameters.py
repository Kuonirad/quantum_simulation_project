...
glProgramEnvParameters4fvEXT = wrapper.wrapper(glProgramEnvParameters4fvEXT).setInputArraySize("params", None)
# INPUT glProgramLocalParameters4fvEXT.params size not checked against count*4
glProgramLocalParameters4fvEXT = wrapper.wrapper(glProgramLocalParameters4fvEXT).setInputArraySize("params", None)
