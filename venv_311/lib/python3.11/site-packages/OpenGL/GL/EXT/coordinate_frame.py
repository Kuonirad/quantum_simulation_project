...
glTangentPointerEXT = wrapper.wrapper(glTangentPointerEXT).setInputArraySize("pointer", None)
# INPUT glBinormalPointerEXT.pointer size not checked against 'type,stride'
glBinormalPointerEXT = wrapper.wrapper(glBinormalPointerEXT).setInputArraySize("pointer", None)
