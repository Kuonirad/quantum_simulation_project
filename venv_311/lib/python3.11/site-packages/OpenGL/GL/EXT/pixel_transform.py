...
glPixelTransformParameterivEXT = wrapper.wrapper(glPixelTransformParameterivEXT).setInputArraySize("params", 1)
glPixelTransformParameterfvEXT = wrapper.wrapper(glPixelTransformParameterfvEXT).setInputArraySize("params", 1)
