...
glTexImage3DEXT = wrapper.wrapper(glTexImage3DEXT).setInputArraySize("pixels", None)
# INPUT glTexSubImage3DEXT.pixels size not checked against 'format,type,width,height,depth'
glTexSubImage3DEXT = wrapper.wrapper(glTexSubImage3DEXT).setInputArraySize("pixels", None)
