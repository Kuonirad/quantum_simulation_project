...
glVertexWeightfvEXT = wrapper.wrapper(glVertexWeightfvEXT).setInputArraySize("weight", 1)
# INPUT glVertexWeightPointerEXT.pointer size not checked against 'type,stride'
glVertexWeightPointerEXT = wrapper.wrapper(glVertexWeightPointerEXT).setInputArraySize("pointer", None)
