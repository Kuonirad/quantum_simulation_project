...
glColorPointerEXT = wrapper.wrapper(glColorPointerEXT).setInputArraySize("pointer", None)
# INPUT glEdgeFlagPointerEXT.pointer size not checked against 'stride,count'
glEdgeFlagPointerEXT = wrapper.wrapper(glEdgeFlagPointerEXT).setInputArraySize("pointer", None)
glGetPointervEXT = wrapper.wrapper(glGetPointervEXT).setOutput("params", size=(1,), orPassIn=True)
# INPUT glIndexPointerEXT.pointer size not checked against 'type,stride,count'
glIndexPointerEXT = wrapper.wrapper(glIndexPointerEXT).setInputArraySize("pointer", None)
# INPUT glNormalPointerEXT.pointer size not checked against 'type,stride,count'
glNormalPointerEXT = wrapper.wrapper(glNormalPointerEXT).setInputArraySize("pointer", None)
# INPUT glTexCoordPointerEXT.pointer size not checked against 'size,type,stride,count'
glTexCoordPointerEXT = wrapper.wrapper(glTexCoordPointerEXT).setInputArraySize("pointer", None)
# INPUT glVertexPointerEXT.pointer size not checked against 'size,type,stride,count'
glVertexPointerEXT = wrapper.wrapper(glVertexPointerEXT).setInputArraySize("pointer", None)
