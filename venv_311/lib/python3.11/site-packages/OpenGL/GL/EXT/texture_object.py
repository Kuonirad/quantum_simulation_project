...
glAreTexturesResidentEXT = (
    wrapper.wrapper(glAreTexturesResidentEXT)
...
glDeleteTexturesEXT = wrapper.wrapper(glDeleteTexturesEXT).setInputArraySize("textures", None)
...
glPrioritizeTexturesEXT = (
    wrapper.wrapper(glPrioritizeTexturesEXT).setInputArraySize("priorities", None).setInputArraySize("textures", None)
)
