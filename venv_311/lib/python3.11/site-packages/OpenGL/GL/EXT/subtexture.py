...
glTexSubImage1DEXT = wrapper.wrapper(glTexSubImage1DEXT).setInputArraySize("pixels", None)
# INPUT glTexSubImage2DEXT.pixels size not checked against 'format,type,width,height'
glTexSubImage2DEXT = wrapper.wrapper(glTexSubImage2DEXT).setInputArraySize("pixels", None)
