...
glMultiDrawArraysEXT = (
    wrapper.wrapper(glMultiDrawArraysEXT).setInputArraySize("count", None).setInputArraySize("first", None)
)
...
glMultiDrawElementsEXT = (
    wrapper.wrapper(glMultiDrawElementsEXT).setInputArraySize("count", None).setInputArraySize("indices", None)
)
