...
glClipPlanefOES = wrapper.wrapper(glClipPlanefOES).setInputArraySize("equation", 4)
glGetClipPlanefOES = wrapper.wrapper(glGetClipPlanefOES).setOutput("equation", size=(4,), orPassIn=True)
