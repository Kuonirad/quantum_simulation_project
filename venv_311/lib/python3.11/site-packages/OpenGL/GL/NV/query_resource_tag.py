...
glGenQueryResourceTagNV = wrapper.wrapper(glGenQueryResourceTagNV).setInputArraySize("tagIds", None)
# INPUT glDeleteQueryResourceTagNV.tagIds size not checked against n
glDeleteQueryResourceTagNV = wrapper.wrapper(glDeleteQueryResourceTagNV).setInputArraySize("tagIds", None)
