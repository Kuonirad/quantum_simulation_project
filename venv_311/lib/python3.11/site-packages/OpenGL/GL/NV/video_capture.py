...
glVideoCaptureStreamParameterivNV = wrapper.wrapper(glVideoCaptureStreamParameterivNV).setInputArraySize("params", None)
# INPUT glVideoCaptureStreamParameterfvNV.params size not checked against 'pname'
glVideoCaptureStreamParameterfvNV = wrapper.wrapper(glVideoCaptureStreamParameterfvNV).setInputArraySize("params", None)
# INPUT glVideoCaptureStreamParameterdvNV.params size not checked against 'pname'
glVideoCaptureStreamParameterdvNV = wrapper.wrapper(glVideoCaptureStreamParameterdvNV).setInputArraySize("params", None)
