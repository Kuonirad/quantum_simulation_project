...
glCreateStatesNV = wrapper.wrapper(glCreateStatesNV).setInputArraySize("states", None)
# INPUT glDeleteStatesNV.states size not checked against n
glDeleteStatesNV = wrapper.wrapper(glDeleteStatesNV).setInputArraySize("states", None)
# INPUT glCreateCommandListsNV.lists size not checked against n
glCreateCommandListsNV = wrapper.wrapper(glCreateCommandListsNV).setInputArraySize("lists", None)
# INPUT glDeleteCommandListsNV.lists size not checked against n
glDeleteCommandListsNV = wrapper.wrapper(glDeleteCommandListsNV).setInputArraySize("lists", None)
