...
glVDPAURegisterVideoSurfaceNV = wrapper.wrapper(glVDPAURegisterVideoSurfaceNV).setInputArraySize("textureNames", None)
...
glVDPAURegisterOutputSurfaceNV = wrapper.wrapper(glVDPAURegisterOutputSurfaceNV).setInputArraySize("textureNames", None)
...
glVDPAUMapSurfacesNV = wrapper.wrapper(glVDPAUMapSurfacesNV).setInputArraySize("surfaces", None)
# INPUT glVDPAUUnmapSurfacesNV.surfaces size not checked against numSurface
glVDPAUUnmapSurfacesNV = wrapper.wrapper(glVDPAUUnmapSurfacesNV).setInputArraySize("surfaces", None)
