...
glDeleteFencesNV = wrapper.wrapper(glDeleteFencesNV).setInputArraySize("fences", None)
glGenFencesNV = wrapper.wrapper(glGenFencesNV).setOutput("fences", size=lambda x: (x,), pnameArg="n", orPassIn=True)
