...
glTransformFeedbackAttribsNV = wrapper.wrapper(glTransformFeedbackAttribsNV).setInputArraySize("attribs", None)
# INPUT glTransformFeedbackVaryingsNV.locations size not checked against count
glTransformFeedbackVaryingsNV = wrapper.wrapper(glTransformFeedbackVaryingsNV).setInputArraySize("locations", None)
# INPUT glActiveVaryingNV.name size not checked against 'name'
glActiveVaryingNV = wrapper.wrapper(glActiveVaryingNV).setInputArraySize("name", None)
# INPUT glGetVaryingLocationNV.name size not checked against 'name'
glGetVaryingLocationNV = wrapper.wrapper(glGetVaryingLocationNV).setInputArraySize("name", None)
# OUTPUT glGetActiveVaryingNV.name COMPSIZE(program, index, bufSize)
glGetActiveVaryingNV = (
    wrapper.wrapper(glGetActiveVaryingNV)
...
glTransformFeedbackStreamAttribsNV = (
    wrapper.wrapper(glTransformFeedbackStreamAttribsNV)
    .setInputArraySize("attribs", None)
    .setInputArraySize("bufstreams", None)
)
