...
glVertexAttribI1ivEXT = wrapper.wrapper(glVertexAttribI1ivEXT).setInputArraySize("v", 1)
glVertexAttribI2ivEXT = wrapper.wrapper(glVertexAttribI2ivEXT).setInputArraySize("v", 2)
glVertexAttribI3ivEXT = wrapper.wrapper(glVertexAttribI3ivEXT).setInputArraySize("v", 3)
glVertexAttribI4ivEXT = wrapper.wrapper(glVertexAttribI4ivEXT).setInputArraySize("v", 4)
glVertexAttribI1uivEXT = wrapper.wrapper(glVertexAttribI1uivEXT).setInputArraySize("v", 1)
glVertexAttribI2uivEXT = wrapper.wrapper(glVertexAttribI2uivEXT).setInputArraySize("v", 2)
glVertexAttribI3uivEXT = wrapper.wrapper(glVertexAttribI3uivEXT).setInputArraySize("v", 3)
glVertexAttribI4uivEXT = wrapper.wrapper(glVertexAttribI4uivEXT).setInputArraySize("v", 4)
glVertexAttribI4bvEXT = wrapper.wrapper(glVertexAttribI4bvEXT).setInputArraySize("v", 4)
glVertexAttribI4svEXT = wrapper.wrapper(glVertexAttribI4svEXT).setInputArraySize("v", 4)
glVertexAttribI4ubvEXT = wrapper.wrapper(glVertexAttribI4ubvEXT).setInputArraySize("v", 4)
glVertexAttribI4usvEXT = wrapper.wrapper(glVertexAttribI4usvEXT).setInputArraySize("v", 4)
# INPUT glVertexAttribIPointerEXT.pointer size not checked against 'size,type,stride'
glVertexAttribIPointerEXT = wrapper.wrapper(glVertexAttribIPointerEXT).setInputArraySize("pointer", None)
glGetVertexAttribIivEXT = wrapper.wrapper(glGetVertexAttribIivEXT).setOutput("params", size=(1,), orPassIn=True)
glGetVertexAttribIuivEXT = wrapper.wrapper(glGetVertexAttribIuivEXT).setOutput("params", size=(1,), orPassIn=True)
