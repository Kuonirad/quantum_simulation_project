...
glMapControlPointsNV = wrapper.wrapper(glMapControlPointsNV).setInputArraySize("points", None)
# INPUT glMapParameterivNV.params size not checked against 'target,pname'
glMapParameterivNV = wrapper.wrapper(glMapParameterivNV).setInputArraySize("params", None)
# INPUT glMapParameterfvNV.params size not checked against 'target,pname'
glMapParameterfvNV = wrapper.wrapper(glMapParameterfvNV).setInputArraySize("params", None)
