...
glCombinerParameterfvNV = wrapper.wrapper(glCombinerParameterfvNV).setInputArraySize("params", None)
# INPUT glCombinerParameterivNV.params size not checked against 'pname'
glCombinerParameterivNV = wrapper.wrapper(glCombinerParameterivNV).setInputArraySize("params", None)
