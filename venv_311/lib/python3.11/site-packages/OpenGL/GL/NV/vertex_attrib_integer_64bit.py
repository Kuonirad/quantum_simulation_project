...
glVertexAttribL1i64vNV = wrapper.wrapper(glVertexAttribL1i64vNV).setInputArraySize("v", 1)
glVertexAttribL2i64vNV = wrapper.wrapper(glVertexAttribL2i64vNV).setInputArraySize("v", 2)
glVertexAttribL3i64vNV = wrapper.wrapper(glVertexAttribL3i64vNV).setInputArraySize("v", 3)
glVertexAttribL4i64vNV = wrapper.wrapper(glVertexAttribL4i64vNV).setInputArraySize("v", 4)
glVertexAttribL1ui64vNV = wrapper.wrapper(glVertexAttribL1ui64vNV).setInputArraySize("v", 1)
glVertexAttribL2ui64vNV = wrapper.wrapper(glVertexAttribL2ui64vNV).setInputArraySize("v", 2)
glVertexAttribL3ui64vNV = wrapper.wrapper(glVertexAttribL3ui64vNV).setInputArraySize("v", 3)
glVertexAttribL4ui64vNV = wrapper.wrapper(glVertexAttribL4ui64vNV).setInputArraySize("v", 4)
