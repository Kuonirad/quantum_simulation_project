...
glProgramBufferParametersfvNV = wrapper.wrapper(glProgramBufferParametersfvNV).setInputArraySize("params", None)
# INPUT glProgramBufferParametersIivNV.params size not checked against count
glProgramBufferParametersIivNV = wrapper.wrapper(glProgramBufferParametersIivNV).setInputArraySize("params", None)
# INPUT glProgramBufferParametersIuivNV.params size not checked against count
glProgramBufferParametersIuivNV = wrapper.wrapper(glProgramBufferParametersIuivNV).setInputArraySize("params", None)
