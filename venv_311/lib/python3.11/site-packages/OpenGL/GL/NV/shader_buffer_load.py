...
glUniformui64vNV = wrapper.wrapper(glUniformui64vNV).setInputArraySize("value", None)
...
glProgramUniformui64vNV = wrapper.wrapper(glProgramUniformui64vNV).setInputArraySize("value", None)
