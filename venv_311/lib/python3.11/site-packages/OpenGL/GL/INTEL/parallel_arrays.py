...
glVertexPointervINTEL = wrapper.wrapper(glVertexPointervINTEL).setInputArraySize("pointer", 4)
glNormalPointervINTEL = wrapper.wrapper(glNormalPointervINTEL).setInputArraySize("pointer", 4)
glColorPointervINTEL = wrapper.wrapper(glColorPointervINTEL).setInputArraySize("pointer", 4)
glTexCoordPointervINTEL = wrapper.wrapper(glTexCoordPointervINTEL).setInputArraySize("pointer", 4)
