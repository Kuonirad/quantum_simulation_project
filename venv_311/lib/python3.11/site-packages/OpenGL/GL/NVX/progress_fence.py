...
glSignalSemaphoreui64NVX = (
    wrapper.wrapper(glSignalSemaphoreui64NVX)
    .setInputArraySize("fenceValueArray", None)
    .setInputArraySize("semaphoreArray", None)
)
...
glWaitSemaphoreui64NVX = (
    wrapper.wrapper(glWaitSemaphoreui64NVX)
    .setInputArraySize("fenceValueArray", None)
    .setInputArraySize("semaphoreArray", None)
)
...
glClientWaitSemaphoreui64NVX = (
    wrapper.wrapper(glClientWaitSemaphoreui64NVX)
    .setInputArraySize("fenceValueArray", None)
    .setInputArraySize("semaphoreArray", None)
)
