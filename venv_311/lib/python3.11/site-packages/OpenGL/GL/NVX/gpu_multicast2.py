...
glMulticastViewportArrayvNVX = wrapper.wrapper(glMulticastViewportArrayvNVX).setInputArraySize("v", None)
# INPUT glMulticastScissorArrayvNVX.v size not checked against 'count'
glMulticastScissorArrayvNVX = wrapper.wrapper(glMulticastScissorArrayvNVX).setInputArraySize("v", None)
...
glAsyncCopyBufferSubDataNVX = (
    wrapper.wrapper(glAsyncCopyBufferSubDataNVX)
    .setInputArraySize("fenceValueArray", None)
    .setInputArraySize("signalSemaphoreArray", None)
    .setInputArraySize("signalValueArray", None)
    .setInputArraySize("waitSemaphoreArray", None)
)
...
glAsyncCopyImageSubDataNVX = (
    wrapper.wrapper(glAsyncCopyImageSubDataNVX)
    .setInputArraySize("signalSemaphoreArray", None)
    .setInputArraySize("signalValueArray", None)
    .setInputArraySize("waitSemaphoreArray", None)
    .setInputArraySize("waitValueArray", None)
)
