...
glMapVertexAttrib1dAPPLE = wrapper.wrapper(glMapVertexAttrib1dAPPLE).setInputArraySize("points", None)
# INPUT glMapVertexAttrib1fAPPLE.points size not checked against 'size,stride,order'
glMapVertexAttrib1fAPPLE = wrapper.wrapper(glMapVertexAttrib1fAPPLE).setInputArraySize("points", None)
# INPUT glMapVertexAttrib2dAPPLE.points size not checked against 'size,ustride,uorder,vstride,vorder'
glMapVertexAttrib2dAPPLE = wrapper.wrapper(glMapVertexAttrib2dAPPLE).setInputArraySize("points", None)
# INPUT glMapVertexAttrib2fAPPLE.points size not checked against 'size,ustride,uorder,vstride,vorder'
glMapVertexAttrib2fAPPLE = wrapper.wrapper(glMapVertexAttrib2fAPPLE).setInputArraySize("points", None)
