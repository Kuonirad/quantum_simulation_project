...
glElementPointerAPPLE = wrapper.wrapper(glElementPointerAPPLE).setInputArraySize("pointer", None)
...
glMultiDrawElementArrayAPPLE = (
    wrapper.wrapper(glMultiDrawElementArrayAPPLE).setInputArraySize("count", None).setInputArraySize("first", None)
)
...
glMultiDrawRangeElementArrayAPPLE = (
    wrapper.wrapper(glMultiDrawRangeElementArrayAPPLE).setInputArraySize("count", None).setInputArraySize("first", None)
)
