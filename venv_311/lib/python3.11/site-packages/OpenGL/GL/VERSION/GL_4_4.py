...
glBufferStorage = wrapper.wrapper(glBufferStorage).setInputArraySize("data", None)
# INPUT glClearTexImage.data size not checked against 'format,type'
glClearTexImage = wrapper.wrapper(glClearTexImage).setInputArraySize("data", None)
# INPUT glClearTexSubImage.data size not checked against 'format,type'
glClearTexSubImage = wrapper.wrapper(glClearTexSubImage).setInputArraySize("data", None)
# INPUT glBindBuffersBase.buffers size not checked against count
glBindBuffersBase = wrapper.wrapper(glBindBuffersBase).setInputArraySize("buffers", None)
...
glBindBuffersRange = (
    wrapper.wrapper(glBindBuffersRange)
    .setInputArraySize("buffers", None)
    .setInputArraySize("offsets", None)
    .setInputArraySize("sizes", None)
)
# INPUT glBindTextures.textures size not checked against count
glBindTextures = wrapper.wrapper(glBindTextures).setInputArraySize("textures", None)
# INPUT glBindSamplers.samplers size not checked against count
glBindSamplers = wrapper.wrapper(glBindSamplers).setInputArraySize("samplers", None)
# INPUT glBindImageTextures.textures size not checked against count
glBindImageTextures = wrapper.wrapper(glBindImageTextures).setInputArraySize("textures", None)
...
glBindVertexBuffers = (
    wrapper.wrapper(glBindVertexBuffers)
    .setInputArraySize("buffers", None)
    .setInputArraySize("offsets", None)
    .setInputArraySize("strides", None)
)
