...
glTexSubImage1D = wrapper.wrapper(glTexSubImage1D).setInputArraySize("pixels", None)
...
glEdgeFlagPointer = wrapper.wrapper(glEdgeFlagPointer).setInputArraySize("pointer", None)
# INPUT glIndexPointer.pointer size not checked against 'type,stride'
glIndexPointer = wrapper.wrapper(glIndexPointer).setInputArraySize("pointer", None)
# INPUT glInterleavedArrays.pointer size not checked against 'format,stride'
glInterleavedArrays = wrapper.wrapper(glInterleavedArrays).setInputArraySize("pointer", None)
...
glAreTexturesResident = (
    wrapper.wrapper(glAreTexturesResident)
    .setOutput("residences", size=lambda x: (x,), pnameArg="n", orPassIn=True)
    .setInputArraySize("textures", None)
)
...
glPrioritizeTextures = (
    wrapper.wrapper(glPrioritizeTextures).setInputArraySize("priorities", None).setInputArraySize("textures", None)
)
glIndexubv = wrapper.wrapper(glIndexubv).setInputArraySize("c", 1)
