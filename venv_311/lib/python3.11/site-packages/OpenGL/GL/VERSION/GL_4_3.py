...
glClearBufferData = wrapper.wrapper(glClearBufferData).setInputArraySize("data", None)
# INPUT glClearBufferSubData.data size not checked against 'format,type'
glClearBufferSubData = wrapper.wrapper(glClearBufferSubData).setInputArraySize("data", None)
...
glMultiDrawArraysIndirect = wrapper.wrapper(glMultiDrawArraysIndirect).setInputArraySize("indirect", None)
# INPUT glMultiDrawElementsIndirect.indirect size not checked against 'drawcount,stride'
glMultiDrawElementsIndirect = wrapper.wrapper(glMultiDrawElementsIndirect).setInputArraySize("indirect", None)
...
glGetProgramResourceLocationIndex = wrapper.wrapper(glGetProgramResourceLocationIndex).setInputArraySize("name", None)
# INPUT glDebugMessageControl.ids size not checked against count
glDebugMessageControl = wrapper.wrapper(glDebugMessageControl).setInputArraySize("ids", None)
# INPUT glDebugMessageInsert.buf size not checked against 'buf,length'
glDebugMessageInsert = wrapper.wrapper(glDebugMessageInsert).setInputArraySize("buf", None)
glGetDebugMessageLog = (
    wrapper.wrapper(glGetDebugMessageLog)
    .setOutput("ids", size=lambda x: (x,), pnameArg="count", orPassIn=True)
    .setOutput("lengths", size=lambda x: (x,), pnameArg="count", orPassIn=True)
    .setOutput("messageLog", size=lambda x: (x,), pnameArg="bufSize", orPassIn=True)
    .setOutput("severities", size=lambda x: (x,), pnameArg="count", orPassIn=True)
    .setOutput("sources", size=lambda x: (x,), pnameArg="count", orPassIn=True)
    .setOutput("types", size=lambda x: (x,), pnameArg="count", orPassIn=True)
)
# INPUT glPushDebugGroup.message size not checked against 'message,length'
glPushDebugGroup = wrapper.wrapper(glPushDebugGroup).setInputArraySize("message", None)
# INPUT glObjectLabel.label size not checked against 'label,length'
glObjectLabel = wrapper.wrapper(glObjectLabel).setInputArraySize("label", None)
glGetObjectLabel = (
    wrapper.wrapper(glGetObjectLabel)
    .setOutput("label", size=lambda x: (x,), pnameArg="bufSize", orPassIn=True)
    .setOutput("length", size=(1,), orPassIn=True)
)
# INPUT glObjectPtrLabel.label size not checked against 'label,length'
glObjectPtrLabel = wrapper.wrapper(glObjectPtrLabel).setInputArraySize("label", None)
glGetObjectPtrLabel = (
    wrapper.wrapper(glGetObjectPtrLabel)
    .setOutput("label", size=lambda x: (x,), pnameArg="bufSize", orPassIn=True)
    .setOutput("length", size=(1,), orPassIn=True)
)
