...
glGetVertexAttribdv = wrapper.wrapper(glGetVertexAttribdv).setOutput("params", size=(4,), orPassIn=True)
glGetVertexAttribfv = wrapper.wrapper(glGetVertexAttribfv).setOutput("params", size=(4,), orPassIn=True)
glGetVertexAttribiv = wrapper.wrapper(glGetVertexAttribiv).setOutput("params", size=(4,), orPassIn=True)
glGetVertexAttribPointerv = wrapper.wrapper(glGetVertexAttribPointerv).setOutput("pointer", size=(1,), orPassIn=True)
# INPUT glShaderSource.length size not checked against count
# INPUT glShaderSource.string size not checked against count
glShaderSource = wrapper.wrapper(glShaderSource).setInputArraySize("length", None).setInputArraySize("string", None)
...
glUniformMatrix2fv = wrapper.wrapper(glUniformMatrix2fv).setInputArraySize("value", None)
# INPUT glUniformMatrix3fv.value size not checked against count*9
glUniformMatrix3fv = wrapper.wrapper(glUniformMatrix3fv).setInputArraySize("value", None)
# INPUT glUniformMatrix4fv.value size not checked against count*16
glUniformMatrix4fv = wrapper.wrapper(glUniformMatrix4fv).setInputArraySize("value", None)
glVertexAttrib1dv = wrapper.wrapper(glVertexAttrib1dv).setInputArraySize("v", 1)
glVertexAttrib1fv = wrapper.wrapper(glVertexAttrib1fv).setInputArraySize("v", 1)
glVertexAttrib1sv = wrapper.wrapper(glVertexAttrib1sv).setInputArraySize("v", 1)
glVertexAttrib2dv = wrapper.wrapper(glVertexAttrib2dv).setInputArraySize("v", 2)
glVertexAttrib2fv = wrapper.wrapper(glVertexAttrib2fv).setInputArraySize("v", 2)
glVertexAttrib2sv = wrapper.wrapper(glVertexAttrib2sv).setInputArraySize("v", 2)
glVertexAttrib3dv = wrapper.wrapper(glVertexAttrib3dv).setInputArraySize("v", 3)
glVertexAttrib3fv = wrapper.wrapper(glVertexAttrib3fv).setInputArraySize("v", 3)
glVertexAttrib3sv = wrapper.wrapper(glVertexAttrib3sv).setInputArraySize("v", 3)
glVertexAttrib4Nbv = wrapper.wrapper(glVertexAttrib4Nbv).setInputArraySize("v", 4)
glVertexAttrib4Niv = wrapper.wrapper(glVertexAttrib4Niv).setInputArraySize("v", 4)
glVertexAttrib4Nsv = wrapper.wrapper(glVertexAttrib4Nsv).setInputArraySize("v", 4)
glVertexAttrib4Nubv = wrapper.wrapper(glVertexAttrib4Nubv).setInputArraySize("v", 4)
glVertexAttrib4Nuiv = wrapper.wrapper(glVertexAttrib4Nuiv).setInputArraySize("v", 4)
glVertexAttrib4Nusv = wrapper.wrapper(glVertexAttrib4Nusv).setInputArraySize("v", 4)
glVertexAttrib4bv = wrapper.wrapper(glVertexAttrib4bv).setInputArraySize("v", 4)
glVertexAttrib4dv = wrapper.wrapper(glVertexAttrib4dv).setInputArraySize("v", 4)
glVertexAttrib4fv = wrapper.wrapper(glVertexAttrib4fv).setInputArraySize("v", 4)
glVertexAttrib4iv = wrapper.wrapper(glVertexAttrib4iv).setInputArraySize("v", 4)
glVertexAttrib4sv = wrapper.wrapper(glVertexAttrib4sv).setInputArraySize("v", 4)
glVertexAttrib4ubv = wrapper.wrapper(glVertexAttrib4ubv).setInputArraySize("v", 4)
glVertexAttrib4uiv = wrapper.wrapper(glVertexAttrib4uiv).setInputArraySize("v", 4)
glVertexAttrib4usv = wrapper.wrapper(glVertexAttrib4usv).setInputArraySize("v", 4)
# INPUT glVertexAttribPointer.pointer size not checked against 'size,type,stride'
glVertexAttribPointer = wrapper.wrapper(glVertexAttribPointer).setInputArraySize("pointer", None)
...
glShaderSource = (
    ...
    .setPyConverter("count")  # number of strings
