...
glUniformMatrix2dv = wrapper.wrapper(glUniformMatrix2dv).setInputArraySize("value", None)
# INPUT glUniformMatrix3dv.value size not checked against count*9
glUniformMatrix3dv = wrapper.wrapper(glUniformMatrix3dv).setInputArraySize("value", None)
# INPUT glUniformMatrix4dv.value size not checked against count*16
glUniformMatrix4dv = wrapper.wrapper(glUniformMatrix4dv).setInputArraySize("value", None)
# INPUT glUniformMatrix2x3dv.value size not checked against count*6
glUniformMatrix2x3dv = wrapper.wrapper(glUniformMatrix2x3dv).setInputArraySize("value", None)
# INPUT glUniformMatrix2x4dv.value size not checked against count*8
glUniformMatrix2x4dv = wrapper.wrapper(glUniformMatrix2x4dv).setInputArraySize("value", None)
# INPUT glUniformMatrix3x2dv.value size not checked against count*6
glUniformMatrix3x2dv = wrapper.wrapper(glUniformMatrix3x2dv).setInputArraySize("value", None)
# INPUT glUniformMatrix3x4dv.value size not checked against count*12
glUniformMatrix3x4dv = wrapper.wrapper(glUniformMatrix3x4dv).setInputArraySize("value", None)
# INPUT glUniformMatrix4x2dv.value size not checked against count*8
glUniformMatrix4x2dv = wrapper.wrapper(glUniformMatrix4x2dv).setInputArraySize("value", None)
# INPUT glUniformMatrix4x3dv.value size not checked against count*12
glUniformMatrix4x3dv = wrapper.wrapper(glUniformMatrix4x3dv).setInputArraySize("value", None)
...
glGetActiveSubroutineUniformName = (
    wrapper.wrapper(glGetActiveSubroutineUniformName)
    .setOutput("length", size=(1,), orPassIn=True)
    .setOutput("name", size=lambda x: (x,), pnameArg="bufsize", orPassIn=True)
)
glGetActiveSubroutineName = (
    wrapper.wrapper(glGetActiveSubroutineName)
    .setOutput("length", size=(1,), orPassIn=True)
    .setOutput("name", size=lambda x: (x,), pnameArg="bufsize", orPassIn=True)
)
# INPUT glUniformSubroutinesuiv.indices size not checked against count
glUniformSubroutinesuiv = wrapper.wrapper(glUniformSubroutinesuiv).setInputArraySize("indices", None)
glGetUniformSubroutineuiv = wrapper.wrapper(glGetUniformSubroutineuiv).setOutput("params", size=(1,), orPassIn=True)
glGetProgramStageiv = wrapper.wrapper(glGetProgramStageiv).setOutput("values", size=(1,), orPassIn=True)
# INPUT glPatchParameterfv.values size not checked against 'pname'
glPatchParameterfv = wrapper.wrapper(glPatchParameterfv).setInputArraySize("values", None)
