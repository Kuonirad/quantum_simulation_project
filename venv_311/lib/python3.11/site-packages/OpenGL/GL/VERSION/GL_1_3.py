...
glCompressedTexImage1D = wrapper.wrapper(glCompressedTexImage1D).setInputArraySize("data", None)
...
glCompressedTexSubImage1D = wrapper.wrapper(glCompressedTexSubImage1D).setInputArraySize("data", None)
...
glLoadTransposeMatrixf = wrapper.wrapper(glLoadTransposeMatrixf).setInputArraySize("m", 16)
glLoadTransposeMatrixd = wrapper.wrapper(glLoadTransposeMatrixd).setInputArraySize("m", 16)
glMultTransposeMatrixf = wrapper.wrapper(glMultTransposeMatrixf).setInputArraySize("m", 16)
glMultTransposeMatrixd = wrapper.wrapper(glMultTransposeMatrixd).setInputArraySize("m", 16)
