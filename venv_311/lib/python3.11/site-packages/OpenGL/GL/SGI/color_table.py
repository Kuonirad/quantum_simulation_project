...
glColorTableSGI = wrapper.wrapper(glColorTableSGI).setInputArraySize("table", None)
# INPUT glColorTableParameterfvSGI.params size not checked against 'pname'
glColorTableParameterfvSGI = wrapper.wrapper(glColorTableParameterfvSGI).setInputArraySize("params", None)
# INPUT glColorTableParameterivSGI.params size not checked against 'pname'
glColorTableParameterivSGI = wrapper.wrapper(glColorTableParameterivSGI).setInputArraySize("params", None)
