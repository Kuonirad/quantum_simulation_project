...
glNewObjectBufferATI = wrapper.wrapper(glNewObjectBufferATI).setInputArraySize("pointer", None)
# INPUT glUpdateObjectBufferATI.pointer size not checked against size
glUpdateObjectBufferATI = wrapper.wrapper(glUpdateObjectBufferATI).setInputArraySize("pointer", None)
glGetObjectBufferfvATI = wrapper.wrapper(glGetObjectBufferfvATI).setOutput("params", size=(1,), orPassIn=True)
glGetObjectBufferivATI = wrapper.wrapper(glGetObjectBufferivATI).setOutput("params", size=(1,), orPassIn=True)
glGetArrayObjectfvATI = wrapper.wrapper(glGetArrayObjectfvATI).setOutput("params", size=(1,), orPassIn=True)
glGetArrayObjectivATI = wrapper.wrapper(glGetArrayObjectivATI).setOutput("params", size=(1,), orPassIn=True)
