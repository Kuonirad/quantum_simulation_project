...
glTexBumpParameterivATI = wrapper.wrapper(glTexBumpParameterivATI).setInputArraySize("param", None)
# INPUT glTexBumpParameterfvATI.param size not checked against 'pname'
glTexBumpParameterfvATI = wrapper.wrapper(glTexBumpParameterfvATI).setInputArraySize("param", None)
