...
glColorPointerListIBM = wrapper.wrapper(glColorPointerListIBM).setInputArraySize("pointer", None)
# INPUT glSecondaryColorPointerListIBM.pointer size not checked against 'size,type,stride'
glSecondaryColorPointerListIBM = wrapper.wrapper(glSecondaryColorPointerListIBM).setInputArraySize("pointer", None)
# INPUT glEdgeFlagPointerListIBM.pointer size not checked against 'stride'
glEdgeFlagPointerListIBM = wrapper.wrapper(glEdgeFlagPointerListIBM).setInputArraySize("pointer", None)
# INPUT glFogCoordPointerListIBM.pointer size not checked against 'type,stride'
glFogCoordPointerListIBM = wrapper.wrapper(glFogCoordPointerListIBM).setInputArraySize("pointer", None)
# INPUT glIndexPointerListIBM.pointer size not checked against 'type,stride'
glIndexPointerListIBM = wrapper.wrapper(glIndexPointerListIBM).setInputArraySize("pointer", None)
# INPUT glNormalPointerListIBM.pointer size not checked against 'type,stride'
glNormalPointerListIBM = wrapper.wrapper(glNormalPointerListIBM).setInputArraySize("pointer", None)
# INPUT glTexCoordPointerListIBM.pointer size not checked against 'size,type,stride'
glTexCoordPointerListIBM = wrapper.wrapper(glTexCoordPointerListIBM).setInputArraySize("pointer", None)
# INPUT glVertexPointerListIBM.pointer size not checked against 'size,type,stride'
glVertexPointerListIBM = wrapper.wrapper(glVertexPointerListIBM).setInputArraySize("pointer", None)
