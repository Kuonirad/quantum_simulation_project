...
def _baseWrap(base, lengthName="ncp", contourName="contour", divisor=2):
    ...
    return (
        ...
        .setCConverter(
            lengthName,
            _lengthOfArgname(contourName, divisor, arrays.GLdoubleArray),
        )
    )
...
gleExtrusion = _baseWrap(_baseWrap(_simple.gleExtrusion), "npoints", "point_array", 3)
gleSuperExtrusion = _baseWrap(_baseWrap(_simple.gleSuperExtrusion), "npoints", "point_array", 3)
gleTwistExtrusion = _baseWrap(_baseWrap(_simple.gleTwistExtrusion), "npoints", "point_array", 3)
