...
class QAbstractPrintDialog(QtWidgets.QDialog):
    ...
    class PrintDialogOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QAbstractPrintDialog.PrintDialogOptions", "QAbstractPrintDialog.PrintDialogOption"]
        ) -> None: ...
    ...
    def setEnabledOptions(
        self, options: typing.Union["QAbstractPrintDialog.PrintDialogOptions", "QAbstractPrintDialog.PrintDialogOption"]
    ) -> None: ...
