...
class QGeoAreaMonitorSource(QtCore.QObject):
    ...
    class AreaMonitorFeatures(PyQt5.sip.wrapper):
        ...
        def __init__(
            self,
            f: typing.Union["QGeoAreaMonitorSource.AreaMonitorFeatures", "QGeoAreaMonitorSource.AreaMonitorFeature"],
        ) -> None: ...
...
class QGeoPositionInfo(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def __init__(
        self, coordinate: QGeoCoordinate, updateTime: typing.Union[QtCore.QDateTime, datetime.datetime]
    ) -> None: ...
    @typing.overload
...
class QGeoPositionInfoSource(QtCore.QObject):
    ...
    class PositioningMethods(PyQt5.sip.wrapper):
        ...
        def __init__(
            self,
            f: typing.Union["QGeoPositionInfoSource.PositioningMethods", "QGeoPositionInfoSource.PositioningMethod"],
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    @staticmethod
    def createSource(
        sourceName: str, parameters: typing.Dict[str, typing.Any], parent: QtCore.QObject
    ...
    def setPreferredPositioningMethods(
        self,
        methods: typing.Union["QGeoPositionInfoSource.PositioningMethods", "QGeoPositionInfoSource.PositioningMethod"],
    ) -> None: ...
...
class QNmeaPositionInfoSource(QGeoPositionInfoSource):
    ...
    def __init__(
        self, updateMode: "QNmeaPositionInfoSource.UpdateMode", parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
