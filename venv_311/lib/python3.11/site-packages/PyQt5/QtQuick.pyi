...
class QQuickItem(QtCore.QObject, QtQml.QQmlParserStatus):
    ...
    def updateInputMethod(
        self, queries: typing.Union[QtCore.Qt.InputMethodQueries, QtCore.Qt.InputMethodQuery] = ...
    ) -> None: ...
...
class QQuickImageProvider(QtQml.QQmlImageProviderBase):
    ...
    def __init__(
        ...
        flags: typing.Union[QtQml.QQmlImageProviderBase.Flags, QtQml.QQmlImageProviderBase.Flag] = ...,
    ) -> None: ...
    @typing.overload
...
class QQuickPaintedItem(QQuickItem):
    ...
    class PerformanceHints(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QQuickPaintedItem.PerformanceHints", "QQuickPaintedItem.PerformanceHint"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def setPerformanceHints(
        self, hints: typing.Union["QQuickPaintedItem.PerformanceHints", "QQuickPaintedItem.PerformanceHint"]
    ) -> None: ...
...
class QQuickWindow(QtGui.QWindow):
    ...
    class CreateTextureOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QQuickWindow.CreateTextureOptions", "QQuickWindow.CreateTextureOption"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def createTextureFromNativeObject(
        ...
        nativeLayout: int,
        size: QtCore.QSize,
        options: typing.Union["QQuickWindow.CreateTextureOptions", "QQuickWindow.CreateTextureOption"] = ...,
    ) -> "QSGTexture": ...
...
class QSGAbstractRenderer(QtCore.QObject):
    ...
    class ClearMode(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QSGAbstractRenderer.ClearMode", "QSGAbstractRenderer.ClearModeBit"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class MatrixTransformFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QSGAbstractRenderer.MatrixTransformFlags", "QSGAbstractRenderer.MatrixTransformFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def setClearMode(
        self, mode: typing.Union["QSGAbstractRenderer.ClearMode", "QSGAbstractRenderer.ClearModeBit"]
    ) -> None: ...
    ...
    def setProjectionMatrixToRect(
        self,
        rect: QtCore.QRectF,
        flags: typing.Union["QSGAbstractRenderer.MatrixTransformFlags", "QSGAbstractRenderer.MatrixTransformFlag"],
    ) -> None: ...
...
class QSGEngine(QtCore.QObject):
    ...
    class CreateTextureOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QSGEngine.CreateTextureOptions", "QSGEngine.CreateTextureOption"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def createTextureFromId(
        ...
        id: int,
        size: QtCore.QSize,
        options: typing.Union["QSGEngine.CreateTextureOptions", "QSGEngine.CreateTextureOption"] = ...,
    ) -> "QSGTexture": ...
    def createTextureFromImage(
        self,
        image: QtGui.QImage,
...
class QSGGeometry(PyQt5.sip.wrapper):
    ...
    class Attribute(PyQt5.sipsimplewrapper):
        ...
        def createWithAttributeType(
            pos: int, tupleSize: int, primitiveType: int, attributeType: "QSGGeometry.AttributeType"
    ...
    def __init__(
        self, attribs: "QSGGeometry.AttributeSet", vertexCount: int, indexCount: int = ..., indexType: int = ...
    ) -> None: ...
    @staticmethod
...
class QSGImageNode(QSGGeometryNode):
    ...
    class TextureCoordinatesTransformMode(PyQt5.sipsimplewrapper):
        ...
        def __init__(
            self,
            f: typing.Union[
                "QSGImageNode.TextureCoordinatesTransformMode", "QSGImageNode.TextureCoordinatesTransformFlag"
            ],
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
...
class QSGMaterialShader(PyQt5.sip.wrapper):
    class RenderState(PyQt5.sipsimplewrapper):
        ...
        class DirtyStates(PyQt5.sipsimplewrapper):
            ...
            def __init__(
                self,
                f: typing.Union[
                    "QSGMaterialShader.RenderState.DirtyStates", "QSGMaterialShader.RenderState.DirtyState"
                ],
            ) -> None: ...
            def __hash__(self) -> int: ...
            def __bool__(self) -> int: ...
    ...
    def setShaderSourceFile(
        self, type: typing.Union[QtGui.QOpenGLShader.ShaderType, QtGui.QOpenGLShader.ShaderTypeBit], sourceFile: str
    ) -> None: ...
    ...
    def updateState(
        self, state: "QSGMaterialShader.RenderState", newMaterial: QSGMaterial, oldMaterial: QSGMaterial
    ) -> None: ...
...
class QSGMaterialRhiShader(QSGMaterialShader):
    ...
    class Flags(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QSGMaterialRhiShader.Flags", "QSGMaterialRhiShader.Flag"]
    ...
    def __init__(self) -> None: ...
    def setFlag(
        self, flags: typing.Union["QSGMaterialRhiShader.Flags", "QSGMaterialRhiShader.Flag"], on: bool = ...
    ) -> None: ...
    ...
    def updateUniformData(
        self, state: "QSGMaterialRhiShader.RenderState", newMaterial: QSGMaterial, oldMaterial: QSGMaterial
    ) -> bool: ...
...
class QSGRendererInterface(PyQt5.sipsimplewrapper):
    ...
    class ShaderCompilationTypes(PyQt5.sipsimplewrapper):
        ...
        def __init__(
            self,
            f: typing.Union[
                "QSGRendererInterface.ShaderCompilationTypes", "QSGRendererInterface.ShaderCompilationType"
            ],
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
    ...
    class ShaderSourceTypes(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QSGRendererInterface.ShaderSourceTypes", "QSGRendererInterface.ShaderSourceType"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QSGRenderNode(QSGNode):
    ...
    class RenderingFlags(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QSGRenderNode.RenderingFlags", "QSGRenderNode.RenderingFlag"]
