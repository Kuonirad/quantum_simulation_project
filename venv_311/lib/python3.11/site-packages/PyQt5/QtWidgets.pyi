...
PYQT_OPENGL_ARRAY = typing.Union[typing.Sequence[int], typing.Sequence[float], PyQt5.sip.Buffer, None]
PYQT_OPENGL_BOUND_ARRAY = typing.Union[typing.Sequence[int], typing.Sequence[float], PyQt5.sip.Buffer, int, None]
...
class QWidget(QtCore.QObject, QtGui.QPaintDevice):
    ...
    def nativeEvent(
        self, eventType: typing.Union[QtCore.QByteArray, bytes, bytearray], message: PyQt5.sip.voidptr
    ...
    def grabGesture(
        self, type: QtCore.Qt.GestureType, flags: typing.Union[QtCore.Qt.GestureFlags, QtCore.Qt.GestureFlag] = ...
    ) -> None: ...
    ...
    def create(
        self, window: PyQt5.sip.voidptr = ..., initializeWindow: bool = ..., destroyOldWindow: bool = ...
    ) -> None: ...
...
class QAbstractScrollArea(QFrame):
    ...
    def addScrollBarWidget(
        self, widget: QWidget, alignment: typing.Union[QtCore.Qt.Alignment, QtCore.Qt.AlignmentFlag]
    ) -> None: ...
...
class QAbstractItemView(QAbstractScrollArea):
    ...
    class EditTriggers(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QAbstractItemView.EditTriggers", "QAbstractItemView.EditTrigger"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def setSelection(
        self,
        rect: QtCore.QRect,
        command: typing.Union[QtCore.QItemSelectionModel.SelectionFlags, QtCore.QItemSelectionModel.SelectionFlag],
    ) -> None: ...
    ...
    def dataChanged(
        self, topLeft: QtCore.QModelIndex, bottomRight: QtCore.QModelIndex, roles: typing.Iterable[int] = ...
    ) -> None: ...
    @typing.overload
    def update(self) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def edit(
        self, index: QtCore.QModelIndex, trigger: "QAbstractItemView.EditTrigger", event: QtCore.QEvent
    ) -> bool: ...
    ...
    def setEditTriggers(
        self, triggers: typing.Union["QAbstractItemView.EditTriggers", "QAbstractItemView.EditTrigger"]
    ) -> None: ...
...
class QAbstractSlider(QWidget):
    ...
    def setRepeatAction(
        self, action: "QAbstractSlider.SliderAction", thresholdTime: int = ..., repeatTime: int = ...
    ) -> None: ...
...
class QAbstractSpinBox(QWidget):
    ...
    class StepEnabled(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QAbstractSpinBox.StepEnabled", "QAbstractSpinBox.StepEnabledFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QAction(QtCore.QObject):
    ...
    @typing.overload
    def setShortcuts(
        self, shortcuts: typing.Iterable[typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, str, int]]
    ) -> None: ...
    @typing.overload
    ...
    def shortcut(self) -> QtGui.QKeySequence: ...
    def setShortcut(
        self, shortcut: typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, str, int]
    ) -> None: ...
...
class QLayout(QtCore.QObject, QLayoutItem):
    ...
    def replaceWidget(
        ...
        from_: QWidget,
        to: QWidget,
        options: typing.Union[QtCore.Qt.FindChildOptions, QtCore.Qt.FindChildOption] = ...,
    ) -> QLayoutItem: ...
    def controlTypes(self) -> "QSizePolicy.ControlTypes": ...
    def contentsMargins(self) -> QtCore.QMargins: ...
    def contentsRect(self) -> QtCore.QRect: ...
    ...
    @typing.overload
    def setAlignment(
        self, w: QWidget, alignment: typing.Union[QtCore.Qt.Alignment, QtCore.Qt.AlignmentFlag]
    ) -> bool: ...
    @typing.overload
    def setAlignment(
        self, l: "QLayout", alignment: typing.Union[QtCore.Qt.Alignment, QtCore.Qt.AlignmentFlag]
    ) -> bool: ...
    @typing.overload
...
class QCalendarWidget(QWidget):
    ...
    def setDateRange(
        self, min: typing.Union[QtCore.QDate, datetime.date], max: typing.Union[QtCore.QDate, datetime.date]
    ) -> None: ...
    def setCurrentPage(self, year: int, month: int) -> None: ...
    def paintCell(
        self, painter: QtGui.QPainter, rect: QtCore.QRect, date: typing.Union[QtCore.QDate, datetime.date]
    ) -> None: ...
    ...
    def setDateTextFormat(
        self, date: typing.Union[QtCore.QDate, datetime.date], color: QtGui.QTextCharFormat
    ) -> None: ...
    @typing.overload
...
class QColorDialog(QDialog):
    ...
    class ColorDialogOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QColorDialog.ColorDialogOptions", "QColorDialog.ColorDialogOption"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    @typing.overload
    def __init__(
        self, initial: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor], parent: typing.Optional[QWidget] = ...
    ) -> None: ...
    def setVisible(self, visible: bool) -> None: ...
    @typing.overload
    def open(self) -> None: ...
    ...
    def setOptions(
        self, options: typing.Union["QColorDialog.ColorDialogOptions", "QColorDialog.ColorDialogOption"]
    ) -> None: ...
    ...
    def getColor(
        ...
        parent: typing.Optional[QWidget] = ...,
        title: str = ...,
        options: typing.Union["QColorDialog.ColorDialogOptions", "QColorDialog.ColorDialogOption"] = ...,
    ) -> QtGui.QColor: ...
...
class QComboBox(QWidget):
    ...
    def findData(
        self, data: typing.Any, role: int = ..., flags: typing.Union[QtCore.Qt.MatchFlags, QtCore.Qt.MatchFlag] = ...
    ) -> int: ...
...
class QStyle(QtCore.QObject):
    ...
    @staticmethod
    def visualAlignment(
        direction: QtCore.Qt.LayoutDirection, alignment: typing.Union[QtCore.Qt.Alignment, QtCore.Qt.AlignmentFlag]
    ) -> QtCore.Qt.Alignment: ...
    @staticmethod
    ...
    @staticmethod
    def visualPos(
        direction: QtCore.Qt.LayoutDirection, boundingRect: QtCore.QRect, logicalPos: QtCore.QPoint
    ) -> QtCore.QPoint: ...
    @staticmethod
    def visualRect(
        direction: QtCore.Qt.LayoutDirection, boundingRect: QtCore.QRect, logicalRect: QtCore.QRect
    ) -> QtCore.QRect: ...
    ...
    def subElementRect(
        self, subElement: "QStyle.SubElement", option: "QStyleOption", widget: typing.Optional[QWidget] = ...
    ) -> QtCore.QRect: ...
    def drawControl(
        self,
    ...
    def drawItemPixmap(
        self, painter: QtGui.QPainter, rect: QtCore.QRect, alignment: int, pixmap: QtGui.QPixmap
    ) -> None: ...
    def drawItemText(
        self,
        painter: QtGui.QPainter,
    ...
    def itemTextRect(
        self, fm: QtGui.QFontMetrics, r: QtCore.QRect, flags: int, enabled: bool, text: str
    ) -> QtCore.QRect: ...
    @typing.overload
...
class QCommonStyle(QStyle):
    ...
    def subElementRect(
        self, r: QStyle.SubElement, opt: "QStyleOption", widget: typing.Optional[QWidget] = ...
    ) -> QtCore.QRect: ...
    def drawControl(
        self,
        element: QStyle.ControlElement,
...
class QDataWidgetMapper(QtCore.QObject):
    ...
    @typing.overload
    def addMapping(
        self, widget: QWidget, section: int, propertyName: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> None: ...
...
class QDateTimeEdit(QAbstractSpinBox):
    ...
    @typing.overload
    def __init__(
        self, datetime: typing.Union[QtCore.QDateTime, datetime.datetime], parent: typing.Optional[QWidget] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, date: typing.Union[QtCore.QDate, datetime.date], parent: typing.Optional[QWidget] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self, time: typing.Union[QtCore.QTime, datetime.time], parent: typing.Optional[QWidget] = ...
    ) -> None: ...
    def setCalendar(self, calendar: QtCore.QCalendar) -> None: ...
    def calendar(self) -> QtCore.QCalendar: ...
    ...
    def setTimeRange(
        self, min: typing.Union[QtCore.QTime, datetime.time], max: typing.Union[QtCore.QTime, datetime.time]
    ) -> None: ...
...
class QDialogButtonBox(QWidget):
    ...
    class StandardButtons(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QDialogButtonBox.StandardButtons", "QDialogButtonBox.StandardButton"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def __init__(
        self,
        buttons: typing.Union["QDialogButtonBox.StandardButtons", "QDialogButtonBox.StandardButton"],
        parent: typing.Optional[QWidget] = ...,
    ) -> None: ...
    @typing.overload
    def __init__(
    ...
    def setStandardButtons(
        self, buttons: typing.Union["QDialogButtonBox.StandardButtons", "QDialogButtonBox.StandardButton"]
    ) -> None: ...
...
class QDirModel(QtCore.QAbstractItemModel):
    ...
    def dropMimeData(
        self, data: QtCore.QMimeData, action: QtCore.Qt.DropAction, row: int, column: int, parent: QtCore.QModelIndex
    ) -> bool: ...
...
class QDockWidget(QWidget):
    ...
    class DockWidgetFeatures(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QDockWidget.DockWidgetFeatures", "QDockWidget.DockWidgetFeature"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def setFeatures(
        self, features: typing.Union["QDockWidget.DockWidgetFeatures", "QDockWidget.DockWidgetFeature"]
    ) -> None: ...
    def setWidget(self, widget: QWidget) -> None: ...
    def widget(self) -> QWidget: ...
...
class QFileDialog(QDialog):
    ...
    @typing.overload
    def __init__(
        self, parent: typing.Optional[QWidget] = ..., caption: str = ..., directory: str = ..., filter: str = ...
    ) -> None: ...
    @staticmethod
    def saveFileContent(
        fileContent: typing.Union[QtCore.QByteArray, bytes, bytearray], fileNameHint: str = ...
    ) -> None: ...
...
class QFileIconProvider(PyQt5.sipsimplewrapper):
    ...
    class Options(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QFileIconProvider.Options", "QFileIconProvider.Option"]
...
class QFontComboBox(QComboBox):
    ...
    class FontFilters(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QFontComboBox.FontFilters", "QFontComboBox.FontFilter"]
    ...
    def setFontFilters(
        self, filters: typing.Union["QFontComboBox.FontFilters", "QFontComboBox.FontFilter"]
    ) -> None: ...
...
class QFontDialog(QDialog):
    ...
    class FontDialogOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QFontDialog.FontDialogOptions", "QFontDialog.FontDialogOption"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def setOptions(
        self, options: typing.Union["QFontDialog.FontDialogOptions", "QFontDialog.FontDialogOption"]
    ) -> None: ...
...
class QPinchGesture(QGesture):
    ...
    class ChangeFlags(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QPinchGesture.ChangeFlags", "QPinchGesture.ChangeFlag"]
    ...
    def setTotalChangeFlags(
        self, value: typing.Union["QPinchGesture.ChangeFlags", "QPinchGesture.ChangeFlag"]
    ) -> None: ...
...
class QGestureRecognizer(PyQt5.sip.wrapper):
    ...
    class Result(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QGestureRecognizer.Result", "QGestureRecognizer.ResultFlag"]
...
class QGraphicsLayoutItem(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def setSizePolicy(
        self, hPolicy: "QSizePolicy.Policy", vPolicy: "QSizePolicy.Policy", controlType: "QSizePolicy.ControlType" = ...
    ) -> None: ...
...
class QGraphicsEffect(QtCore.QObject):
    ...
    class ChangeFlags(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QGraphicsEffect.ChangeFlags", "QGraphicsEffect.ChangeFlag"]
    ...
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    def sourcePixmap(
        self, system: QtCore.Qt.CoordinateSystem = ..., mode: "QGraphicsEffect.PixmapPadMode" = ...
    ...
    def sourceChanged(
        self, flags: typing.Union["QGraphicsEffect.ChangeFlags", "QGraphicsEffect.ChangeFlag"]
    ) -> None: ...
...
class QGraphicsBlurEffect(QGraphicsEffect):
    ...
    class BlurHints(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGraphicsBlurEffect.BlurHints", "QGraphicsBlurEffect.BlurHint"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def setBlurHints(
        self, hints: typing.Union["QGraphicsBlurEffect.BlurHints", "QGraphicsBlurEffect.BlurHint"]
    ) -> None: ...
...
class QGraphicsOpacityEffect(QGraphicsEffect):
    ...
    def setOpacityMask(
        self, mask: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, QtGui.QGradient]
    ) -> None: ...
...
class QGraphicsGridLayout(QGraphicsLayout):
    ...
    def setAlignment(
        self, item: QGraphicsLayoutItem, alignment: typing.Union[QtCore.Qt.Alignment, QtCore.Qt.AlignmentFlag]
    ) -> None: ...
    def columnAlignment(self, column: int) -> QtCore.Qt.Alignment: ...
    def setColumnAlignment(
        self, column: int, alignment: typing.Union[QtCore.Qt.Alignment, QtCore.Qt.AlignmentFlag]
    ) -> None: ...
    def rowAlignment(self, row: int) -> QtCore.Qt.Alignment: ...
    def setRowAlignment(
        self, row: int, alignment: typing.Union[QtCore.Qt.Alignment, QtCore.Qt.AlignmentFlag]
    ) -> None: ...
...
class QGraphicsItem(PyQt5.sip.wrapper):
    ...
    class GraphicsItemFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGraphicsItem.GraphicsItemFlags", "QGraphicsItem.GraphicsItemFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def paint(
        self, painter: QtGui.QPainter, option: "QStyleOptionGraphicsItem", widget: typing.Optional[QWidget] = ...
    ) -> None: ...
    ...
    def toolTip(self) -> str: ...
    def setFlags(
        self, flags: typing.Union["QGraphicsItem.GraphicsItemFlags", "QGraphicsItem.GraphicsItemFlag"]
    ) -> None: ...
...
class QAbstractGraphicsShapeItem(QGraphicsItem):
    ...
    def isObscuredBy(self, item: QGraphicsItem) -> bool: ...
    def setBrush(
        self, brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, QtGui.QGradient]
    ) -> None: ...
...
class QGraphicsRectItem(QAbstractGraphicsShapeItem):
    ...
    @typing.overload
    def __init__(
        self, x: float, y: float, w: float, h: float, parent: typing.Optional[QGraphicsItem] = ...
    ) -> None: ...
    def type(self) -> int: ...
    def opaqueArea(self) -> QtGui.QPainterPath: ...
    def isObscuredBy(self, item: QGraphicsItem) -> bool: ...
...
class QGraphicsLineItem(QGraphicsItem):
    ...
    @typing.overload
    def __init__(
        self, x1: float, y1: float, x2: float, y2: float, parent: typing.Optional[QGraphicsItem] = ...
    ) -> None: ...
    def type(self) -> int: ...
    def opaqueArea(self) -> QtGui.QPainterPath: ...
    def isObscuredBy(self, item: QGraphicsItem) -> bool: ...
...
class QGraphicsTextItem(QGraphicsObject):
    ...
    def setTextInteractionFlags(
        self, flags: typing.Union[QtCore.Qt.TextInteractionFlags, QtCore.Qt.TextInteractionFlag]
    ) -> None: ...
...
class QGraphicsLinearLayout(QGraphicsLayout):
    ...
    @typing.overload
    def __init__(
        self, orientation: QtCore.Qt.Orientation, parent: typing.Optional[QGraphicsLayoutItem] = ...
    ) -> None: ...
    def sizeHint(self, which: QtCore.Qt.SizeHint, constraint: QtCore.QSizeF = ...) -> QtCore.QSizeF: ...
    def invalidate(self) -> None: ...
    def itemAt(self, index: int) -> QGraphicsLayoutItem: ...
...
class QGraphicsScene(QtCore.QObject):
    ...
    class SceneLayers(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QGraphicsScene.SceneLayers", "QGraphicsScene.SceneLayer"]
    ...
    @typing.overload
    def __init__(
        self, x: float, y: float, width: float, height: float, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
    ...
    @typing.overload
    def itemAt(
        self, pos: typing.Union[QtCore.QPointF, QtCore.QPoint], deviceTransform: QtGui.QTransform
    ) -> QGraphicsItem: ...
    @typing.overload
    ...
    def style(self) -> QStyle: ...
    def addWidget(
        self, widget: QWidget, flags: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType] = ...
    ...
    def invalidate(
        self,
        rect: QtCore.QRectF = ...,
        layers: typing.Union["QGraphicsScene.SceneLayers", "QGraphicsScene.SceneLayer"] = ...,
    ) -> None: ...
    @typing.overload
    def invalidate(
        self,
    ...
    def addRect(
        self,
        rect: QtCore.QRectF,
        pen: typing.Union[QtGui.QPen, QtGui.QColor, QtCore.Qt.GlobalColor] = ...,
    ...
    @typing.overload
    def addLine(
        self, line: QtCore.QLineF, pen: typing.Union[QtGui.QPen, QtGui.QColor, QtCore.Qt.GlobalColor] = ...
    ) -> QGraphicsLineItem: ...
    @typing.overload
    def addLine(
        self,
    ...
    def setSelectionArea(
        self, path: QtGui.QPainterPath, mode: QtCore.Qt.ItemSelectionMode = ..., deviceTransform: QtGui.QTransform = ...
    ) -> None: ...
    @typing.overload
    def setSelectionArea(
        self,
...
class QGraphicsView(QAbstractScrollArea):
    ...
    class CacheMode(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QGraphicsView.CacheMode", "QGraphicsView.CacheModeFlag"]
    ...
    class OptimizationFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGraphicsView.OptimizationFlags", "QGraphicsView.OptimizationFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def setOptimizationFlags(
        self, flags: typing.Union["QGraphicsView.OptimizationFlags", "QGraphicsView.OptimizationFlag"]
    ) -> None: ...
...
class QHeaderView(QAbstractItemView):
    ...
    def setSelection(
        self,
        rect: QtCore.QRect,
        flags: typing.Union[QtCore.QItemSelectionModel.SelectionFlags, QtCore.QItemSelectionModel.SelectionFlag],
    ) -> None: ...
    def moveCursor(
        self,
...
class QInputDialog(QDialog):
    ...
    class InputDialogOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QInputDialog.InputDialogOptions", "QInputDialog.InputDialogOption"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def setOptions(
        self, options: typing.Union["QInputDialog.InputDialogOptions", "QInputDialog.InputDialogOption"]
    ) -> None: ...
...
class QItemDelegate(QAbstractItemDelegate):
    ...
    def drawDisplay(
        self, painter: QtGui.QPainter, option: "QStyleOptionViewItem", rect: QtCore.QRect, text: str
    ) -> None: ...
    def drawDecoration(
        self, painter: QtGui.QPainter, option: "QStyleOptionViewItem", rect: QtCore.QRect, pixmap: QtGui.QPixmap
    ) -> None: ...
    def drawCheck(
        self, painter: QtGui.QPainter, option: "QStyleOptionViewItem", rect: QtCore.QRect, state: QtCore.Qt.CheckState
    ) -> None: ...
    def drawBackground(
        self, painter: QtGui.QPainter, option: "QStyleOptionViewItem", index: QtCore.QModelIndex
    ) -> None: ...
...
class QKeyEventTransition(QtCore.QEventTransition):
    ...
    def setModifierMask(
        self, modifiers: typing.Union[QtCore.Qt.KeyboardModifiers, QtCore.Qt.KeyboardModifier]
    ) -> None: ...
...
class QKeySequenceEdit(QWidget):
    ...
    def clear(self) -> None: ...
    def setKeySequence(
        self, keySequence: typing.Union[QtGui.QKeySequence, QtGui.QKeySequence.StandardKey, str, int]
    ) -> None: ...
...
class QSpacerItem(QLayoutItem):
    @typing.overload
    def __init__(
        self, w: int, h: int, hPolicy: "QSizePolicy.Policy" = ..., vPolicy: "QSizePolicy.Policy" = ...
    ) -> None: ...
    @typing.overload
...
class QListWidgetItem(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def __init__(
        self, icon: QtGui.QIcon, text: str, parent: typing.Optional["QListWidget"] = ..., type: int = ...
    ) -> None: ...
    @typing.overload
...
class QMainWindow(QWidget):
    ...
    def resizeDocks(
        self, docks: typing.Iterable[QDockWidget], sizes: typing.Iterable[int], orientation: QtCore.Qt.Orientation
    ) -> None: ...
    ...
    def splitDockWidget(
        self, after: QDockWidget, dockwidget: QDockWidget, orientation: QtCore.Qt.Orientation
    ) -> None: ...
    @typing.overload
    def addDockWidget(self, area: QtCore.Qt.DockWidgetArea, dockwidget: QDockWidget) -> None: ...
    @typing.overload
    def addDockWidget(
        self, area: QtCore.Qt.DockWidgetArea, dockwidget: QDockWidget, orientation: QtCore.Qt.Orientation
    ) -> None: ...
...
class QMdiArea(QAbstractScrollArea):
    ...
    def setBackground(
        self, background: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, QtGui.QGradient]
    ) -> None: ...
    def background(self) -> QtGui.QBrush: ...
...
class QMdiSubWindow(QWidget):
    ...
    class SubWindowOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QMdiSubWindow.SubWindowOptions", "QMdiSubWindow.SubWindowOption"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QMessageBox(QDialog):
    ...
    class StandardButtons(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QMessageBox.StandardButtons", "QMessageBox.StandardButton"]
    ...
    def setStandardButtons(
        self, buttons: typing.Union["QMessageBox.StandardButtons", "QMessageBox.StandardButton"]
    ) -> None: ...
    def removeButton(self, button: QAbstractButton) -> None: ...
    @typing.overload
...
class QPlainTextEdit(QAbstractScrollArea):
    ...
    def moveCursor(
        self, operation: QtGui.QTextCursor.MoveOperation, mode: QtGui.QTextCursor.MoveMode = ...
    ) -> None: ...
    ...
    @typing.overload
    def find(
        self, exp: str, options: typing.Union[QtGui.QTextDocument.FindFlags, QtGui.QTextDocument.FindFlag] = ...
    ) -> bool: ...
    @typing.overload
    def find(
        self,
        exp: QtCore.QRegExp,
        options: typing.Union[QtGui.QTextDocument.FindFlags, QtGui.QTextDocument.FindFlag] = ...,
    ) -> bool: ...
    @typing.overload
    def find(
        self,
...
class QProxyStyle(QCommonStyle):
    ...
    def standardPixmap(
        self, standardPixmap: QStyle.StandardPixmap, opt: "QStyleOption", widget: typing.Optional[QWidget] = ...
    ) -> QtGui.QPixmap: ...
    def standardIcon(
        self,
        standardIcon: QStyle.StandardPixmap,
    ...
    def subControlRect(
        self, cc: QStyle.ComplexControl, opt: "QStyleOptionComplex", sc: QStyle.SubControl, widget: QWidget
    ) -> QtCore.QRect: ...
    def subElementRect(self, element: QStyle.SubElement, option: "QStyleOption", widget: QWidget) -> QtCore.QRect: ...
    def sizeFromContents(
        self, type: QStyle.ContentsType, option: "QStyleOption", size: QtCore.QSize, widget: QWidget
    ) -> QtCore.QSize: ...
    def drawItemPixmap(
        self, painter: QtGui.QPainter, rect: QtCore.QRect, alignment: int, pixmap: QtGui.QPixmap
    ) -> None: ...
...
class QScroller(QtCore.QObject):
    ...
    def stop(self) -> None: ...
    def handleInput(
        self, input: "QScroller.Input", position: typing.Union[QtCore.QPointF, QtCore.QPoint], timestamp: int = ...
    ) -> bool: ...
...
class QSizePolicy(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, horizontal: "QSizePolicy.Policy", vertical: "QSizePolicy.Policy", type: "QSizePolicy.ControlType" = ...
    ) -> None: ...
    @typing.overload
...
class QSplashScreen(QWidget):
    @typing.overload
    def __init__(
        self, pixmap: QtGui.QPixmap = ..., flags: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    def showMessage(
        self, message: str, alignment: int = ..., color: typing.Union[QtGui.QColor, QtCore.Qt.GlobalColor] = ...
    ) -> None: ...
...
class QStyleOptionFrame(QStyleOption):
    ...
    class FrameFeatures(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QStyleOptionFrame.FrameFeatures", "QStyleOptionFrame.FrameFeature"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QStyleOptionButton(QStyleOption):
    ...
    class ButtonFeatures(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QStyleOptionButton.ButtonFeatures", "QStyleOptionButton.ButtonFeature"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QStyleOptionTab(QStyleOption):
    ...
    class CornerWidgets(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QStyleOptionTab.CornerWidgets", "QStyleOptionTab.CornerWidget"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class TabFeatures(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QStyleOptionTab.TabFeatures", "QStyleOptionTab.TabFeature"]
...
class QStyleOptionViewItem(QStyleOption):
    ...
    class ViewItemFeatures(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QStyleOptionViewItem.ViewItemFeatures", "QStyleOptionViewItem.ViewItemFeature"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QStyleOptionToolButton(QStyleOptionComplex):
    ...
    class ToolButtonFeatures(PyQt5.sipsimplewrapper):
        ...
        def __init__(
            self,
            f: typing.Union["QStyleOptionToolButton.ToolButtonFeatures", "QStyleOptionToolButton.ToolButtonFeature"],
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QStyleOptionToolBar(QStyleOption):
    ...
    class ToolBarFeatures(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QStyleOptionToolBar.ToolBarFeatures", "QStyleOptionToolBar.ToolBarFeature"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QSystemTrayIcon(QtCore.QObject):
    ...
    @typing.overload
    def showMessage(
        self, title: str, msg: str, icon: "QSystemTrayIcon.MessageIcon" = ..., msecs: int = ...
    ) -> None: ...
    @typing.overload
...
class QTextEdit(QAbstractScrollArea):
    ...
    class AutoFormatting(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QTextEdit.AutoFormatting", "QTextEdit.AutoFormattingFlag"]
    ...
    def toMarkdown(
        self, features: typing.Union[QtGui.QTextDocument.MarkdownFeatures, QtGui.QTextDocument.MarkdownFeature] = ...
    ) -> str: ...
    def setTabStopDistance(self, distance: float) -> None: ...
    def tabStopDistance(self) -> float: ...
    def placeholderText(self) -> str: ...
    ...
    def setAutoFormatting(
        self, features: typing.Union["QTextEdit.AutoFormatting", "QTextEdit.AutoFormattingFlag"]
    ) -> None: ...
...
class QTreeWidgetItem(PyQt5.sip.wrapper):
    ...
    def setForeground(
        self, column: int, brush: typing.Union[QtGui.QBrush, QtGui.QColor, QtCore.Qt.GlobalColor, QtGui.QGradient]
    ) -> None: ...
...
class QTreeWidget(QTreeView):
    ...
    def supportedDropActions(self) -> QtCore.Qt.DropActions: ...
    def dropMimeData(
        self, parent: QTreeWidgetItem, index: int, data: QtCore.QMimeData, action: QtCore.Qt.DropAction
    ) -> bool: ...
    ...
    def findItems(
        self, text: str, flags: typing.Union[QtCore.Qt.MatchFlags, QtCore.Qt.MatchFlag], column: int = ...
...
class QTreeWidgetItemIterator(PyQt5.sipsimplewrapper):
    ...
    class IteratorFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QTreeWidgetItemIterator.IteratorFlags", "QTreeWidgetItemIterator.IteratorFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QWizardPage(QWidget):
    ...
    def registerField(
        self, name: str, widget: QWidget, property: typing.Optional[str] = ..., changedSignal: PYQT_SIGNAL = ...
    ) -> None: ...
    def field(self, name: str) -> typing.Any: ...
    def setField(self, name: str, value: typing.Any) -> None: ...
...
def qDrawBorderPixmap(
    painter: QtGui.QPainter, target: QtCore.QRect, margins: QtCore.QMargins, pixmap: QtGui.QPixmap
) -> None: ...
@typing.overload
def qDrawPlainRect(
    p: QtGui.QPainter,
