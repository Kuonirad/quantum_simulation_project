...
class QNetworkCacheMetaData(PyQt5.sipsimplewrapper):
    ...
    def setRawHeaders(
        ...
        headers: typing.Iterable[
            typing.Tuple[
                typing.Union[QtCore.QByteArray, bytes, bytearray], typing.Union[QtCore.QByteArray, bytes, bytearray]
            ]
        ],
    ) -> None: ...
...
class QAbstractSocket(QtCore.QIODevice):
    ...
    class BindMode(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QAbstractSocket.BindMode", "QAbstractSocket.BindFlag"]
    ...
    class PauseModes(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QAbstractSocket.PauseModes", "QAbstractSocket.PauseMode"]
    ...
    def bind(
        ...
        port: int = ...,
        mode: typing.Union["QAbstractSocket.BindMode", "QAbstractSocket.BindFlag"] = ...,
    ) -> bool: ...
    @typing.overload
    def bind(
        self, port: int = ..., mode: typing.Union["QAbstractSocket.BindMode", "QAbstractSocket.BindFlag"] = ...
    ) -> bool: ...
    def setPauseMode(
        self, pauseMode: typing.Union["QAbstractSocket.PauseModes", "QAbstractSocket.PauseMode"]
    ) -> None: ...
...
class QHostAddress(PyQt5.sipsimplewrapper):
    ...
    class ConversionMode(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QHostAddress.ConversionMode", "QHostAddress.ConversionModeFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    @typing.overload
    def __init__(
        self, ip6Addr: typing.Tuple[int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int]
    ) -> None: ...
    @typing.overload
    ...
    def isEqual(
        self,
        address: typing.Union["QHostAddress", "QHostAddress.SpecialAddress"],
        mode: typing.Union["QHostAddress.ConversionMode", "QHostAddress.ConversionModeFlag"] = ...,
    ) -> bool: ...
    ...
    @typing.overload
    def isInSubnet(
        self, subnet: typing.Tuple[typing.Union["QHostAddress", "QHostAddress.SpecialAddress"], int]
    ) -> bool: ...
    def __hash__(self) -> int: ...
    def clear(self) -> None: ...
    def isNull(self) -> bool: ...
    ...
    def toIPv6Address(
        self,
    ) -> typing.Tuple[int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int]: ...
...
class QHostInfo(PyQt5.sipsimplewrapper):
    ...
    def setAddresses(
        self, addresses: typing.Iterable[typing.Union[QHostAddress, QHostAddress.SpecialAddress]]
    ) -> None: ...
...
class QHstsPolicy(PyQt5.sipsimplewrapper):
    ...
    def host(
        self, options: typing.Union[QtCore.QUrl.ComponentFormattingOptions, QtCore.QUrl.ComponentFormattingOption] = ...
    ) -> str: ...
...
class QHttpMultiPart(QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, contentType: "QHttpMultiPart.ContentType", parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
...
class QLocalServer(QtCore.QObject):
    ...
    class SocketOptions(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QLocalServer.SocketOptions", "QLocalServer.SocketOption"]
    ...
    def setSocketOptions(
        self, options: typing.Union["QLocalServer.SocketOptions", "QLocalServer.SocketOption"]
    ) -> None: ...
...
class QLocalSocket(QtCore.QIODevice):
    ...
    @typing.overload
    def connectToServer(
        self, name: str, mode: typing.Union[QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag] = ...
    ) -> None: ...
    @typing.overload
    def connectToServer(
        self, mode: typing.Union[QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag] = ...
    ) -> None: ...
...
class QNetworkAccessManager(QtCore.QObject):
    ...
    def connectToHostEncrypted(
        self, hostName: str, port: int = ..., sslConfiguration: "QSslConfiguration" = ...
    ) -> None: ...
    @typing.overload
    def connectToHostEncrypted(
        self, hostName: str, port: int, sslConfiguration: "QSslConfiguration", peerName: str
    ) -> None: ...
    ...
    @typing.overload
    def put(
        self, request: "QNetworkRequest", data: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> "QNetworkReply": ...
    @typing.overload
...
class QNetworkConfigurationManager(QtCore.QObject):
    ...
    class Capabilities(PyQt5.sipsimplewrapper):
        ...
        def __init__(
            self,
            f: typing.Union["QNetworkConfigurationManager.Capabilities", "QNetworkConfigurationManager.Capability"],
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def allConfigurations(
        self, flags: typing.Union["QNetworkConfiguration.StateFlags", "QNetworkConfiguration.StateFlag"] = ...
...
class QNetworkConfiguration(PyQt5.sipsimplewrapper):
    ...
    class StateFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QNetworkConfiguration.StateFlags", "QNetworkConfiguration.StateFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QNetworkInterface(PyQt5.sipsimplewrapper):
    ...
    class InterfaceFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QNetworkInterface.InterfaceFlags", "QNetworkInterface.InterfaceFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QNetworkProxy(PyQt5.sipsimplewrapper):
    ...
    class Capabilities(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QNetworkProxy.Capabilities", "QNetworkProxy.Capability"]
    ...
    def setCapabilities(
        self, capab: typing.Union["QNetworkProxy.Capabilities", "QNetworkProxy.Capability"]
    ) -> None: ...
    def __ne__(self, other: object): ...
    def __eq__(self, other: object): ...
...
class QNetworkProxyQuery(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, hostname: str, port: int, protocolTag: str = ..., type: "QNetworkProxyQuery.QueryType" = ...
    ) -> None: ...
    @typing.overload
...
class QNetworkSession(QtCore.QObject):
    ...
    class UsagePolicies(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QNetworkSession.UsagePolicies", "QNetworkSession.UsagePolicy"]
...
class QSslCertificate(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, data: typing.Union[QtCore.QByteArray, bytes, bytearray] = ..., format: QSsl.EncodingFormat = ...
    ) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def fromData(
        data: typing.Union[QtCore.QByteArray, bytes, bytearray], format: QSsl.EncodingFormat = ...
    ) -> typing.List["QSslCertificate"]: ...
    @staticmethod
    def fromDevice(device: QtCore.QIODevice, format: QSsl.EncodingFormat = ...) -> typing.List["QSslCertificate"]: ...
    @staticmethod
    def fromPath(
        path: str, format: QSsl.EncodingFormat = ..., syntax: QtCore.QRegExp.PatternSyntax = ...
    ) -> typing.List["QSslCertificate"]: ...
...
class QSslConfiguration(PyQt5.sipsimplewrapper):
    ...
    def addCaCertificates(
        self, path: str, format: QSsl.EncodingFormat = ..., syntax: QSslCertificate.PatternSyntax = ...
    ) -> bool: ...
    @typing.overload
    ...
    def setBackendConfiguration(
        self, backendConfiguration: typing.Dict[typing.Union[QtCore.QByteArray, bytes, bytearray], typing.Any] = ...
    ) -> None: ...
    ...
    def setAllowedNextProtocols(
        self, protocols: typing.Iterable[typing.Union[QtCore.QByteArray, bytes, bytearray]]
    ) -> None: ...
...
class QSslDiffieHellmanParameters(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def fromEncoded(
        encoded: typing.Union[QtCore.QByteArray, bytes, bytearray], encoding: QSsl.EncodingFormat = ...
...
class QSslSocket(QTcpSocket):
    ...
    @typing.overload
    def addCaCertificates(
        self, path: str, format: QSsl.EncodingFormat = ..., syntax: QtCore.QRegExp.PatternSyntax = ...
    ) -> bool: ...
    @typing.overload
    def addCaCertificates(self, certificates: typing.Iterable[QSslCertificate]) -> None: ...
    @staticmethod
...
class QTcpServer(QtCore.QObject):
    ...
    def close(self) -> None: ...
    def listen(
        self, address: typing.Union[QHostAddress, QHostAddress.SpecialAddress] = ..., port: int = ...
    ) -> bool: ...
...
class QUdpSocket(QAbstractSocket):
    ...
    def leaveMulticastGroup(
        self, groupAddress: typing.Union[QHostAddress, QHostAddress.SpecialAddress], iface: QNetworkInterface
    ) -> bool: ...
    @typing.overload
    ...
    @typing.overload
    def writeDatagram(
        self, data: PyQt5.sip.array[bytes], host: typing.Union[QHostAddress, QHostAddress.SpecialAddress], port: int
    ) -> int: ...
    @typing.overload
    def writeDatagram(
        self,
