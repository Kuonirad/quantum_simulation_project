...
class QGeoCodeReply(QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, error: "QGeoCodeReply.Error", errorString: str, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
    @typing.overload
...
class QGeoCodingManager(QtCore.QObject):
    ...
    @typing.overload
    def geocode(
        self, searchString: str, limit: int = ..., offset: int = ..., bounds: QtPositioning.QGeoShape = ...
    ) -> QGeoCodeReply: ...
...
class QGeoCodingManagerEngine(QtCore.QObject):
    def __init__(
        self, parameters: typing.Dict[str, typing.Any], parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
...
class QGeoRouteReply(QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, error: "QGeoRouteReply.Error", errorString: str, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
    @typing.overload
...
class QGeoRouteRequest(PyQt5.sipsimplewrapper):
    ...
    class TravelModes(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QGeoRouteRequest.TravelModes", "QGeoRouteRequest.TravelMode"]
    ...
    class FeatureTypes(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGeoRouteRequest.FeatureTypes", "QGeoRouteRequest.FeatureType"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class FeatureWeights(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGeoRouteRequest.FeatureWeights", "QGeoRouteRequest.FeatureWeight"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class RouteOptimizations(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGeoRouteRequest.RouteOptimizations", "QGeoRouteRequest.RouteOptimization"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class SegmentDetails(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGeoRouteRequest.SegmentDetails", "QGeoRouteRequest.SegmentDetail"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class ManeuverDetails(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGeoRouteRequest.ManeuverDetails", "QGeoRouteRequest.ManeuverDetail"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def setRouteOptimization(
        self, optimization: typing.Union["QGeoRouteRequest.RouteOptimizations", "QGeoRouteRequest.RouteOptimization"]
    ) -> None: ...
    ...
    def setFeatureWeight(
        self, featureType: "QGeoRouteRequest.FeatureType", featureWeight: "QGeoRouteRequest.FeatureWeight"
    ) -> None: ...
    def travelModes(self) -> "QGeoRouteRequest.TravelModes": ...
    def setTravelModes(
        self, travelModes: typing.Union["QGeoRouteRequest.TravelModes", "QGeoRouteRequest.TravelMode"]
    ) -> None: ...
...
class QGeoRoutingManagerEngine(QtCore.QObject):
    ...
    def setSupportedManeuverDetails(
        self, maneuverDetails: typing.Union[QGeoRouteRequest.ManeuverDetails, QGeoRouteRequest.ManeuverDetail]
    ) -> None: ...
    def setSupportedSegmentDetails(
        self, segmentDetails: typing.Union[QGeoRouteRequest.SegmentDetails, QGeoRouteRequest.SegmentDetail]
    ) -> None: ...
    def setSupportedRouteOptimizations(
        self, optimizations: typing.Union[QGeoRouteRequest.RouteOptimizations, QGeoRouteRequest.RouteOptimization]
    ) -> None: ...
    def setSupportedFeatureWeights(
        self, featureWeights: typing.Union[QGeoRouteRequest.FeatureWeights, QGeoRouteRequest.FeatureWeight]
    ) -> None: ...
    def setSupportedFeatureTypes(
        self, featureTypes: typing.Union[QGeoRouteRequest.FeatureTypes, QGeoRouteRequest.FeatureType]
    ) -> None: ...
...
class QGeoServiceProvider(QtCore.QObject):
    ...
    class RoutingFeatures(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGeoServiceProvider.RoutingFeatures", "QGeoServiceProvider.RoutingFeature"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class GeocodingFeatures(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGeoServiceProvider.GeocodingFeatures", "QGeoServiceProvider.GeocodingFeature"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class MappingFeatures(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGeoServiceProvider.MappingFeatures", "QGeoServiceProvider.MappingFeature"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class PlacesFeatures(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGeoServiceProvider.PlacesFeatures", "QGeoServiceProvider.PlacesFeature"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class NavigationFeatures(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QGeoServiceProvider.NavigationFeatures", "QGeoServiceProvider.NavigationFeature"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def __init__(
        self, providerName: str, parameters: typing.Dict[str, typing.Any] = ..., allowExperimental: bool = ...
    ) -> None: ...
...
class QPlaceIdReply(QPlaceReply):
    ...
    def __init__(
        self, operationType: "QPlaceIdReply.OperationType", parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
...
class QPlaceSearchRequest(PyQt5.sipsimplewrapper):
    ...
    def setVisibilityScope(
        self, visibilityScopes: typing.Union[QLocation.VisibilityScope, QLocation.Visibility]
    ) -> None: ...
