...
class QVideoFilterRunnable(PyQt5.sipsimplewrapper):
    ...
    class RunFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QVideoFilterRunnable.RunFlags", "QVideoFilterRunnable.RunFlag"]
        ) -> None: ...
    ...
    def run(
        ...
        flags: typing.Union["QVideoFilterRunnable.RunFlags", "QVideoFilterRunnable.RunFlag"],
    ) -> "QVideoFrame": ...
...
class QAudioBuffer(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, data: typing.Union[QtCore.QByteArray, bytes, bytearray], format: "QAudioFormat", startTime: int = ...
    ) -> None: ...
    @typing.overload
...
class QAudioInput(QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, audioDevice: QAudioDeviceInfo, format: QAudioFormat = ..., parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
...
class QMediaRecorder(QtCore.QObject, QMediaBindableInterface):
    ...
    def setEncodingSettings(
        self, audio: "QAudioEncoderSettings", video: "QVideoEncoderSettings" = ..., container: str = ...
    ) -> None: ...
...
class QCamera(QMediaObject):
    ...
    @typing.overload
    def __init__(
        self, device: typing.Union[QtCore.QByteArray, bytes, bytearray], parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
    @typing.overload
...
class QCameraCaptureDestinationControl(QMediaControl):
    ...
    def setCaptureDestination(
        self,
        destination: typing.Union["QCameraImageCapture.CaptureDestinations", "QCameraImageCapture.CaptureDestination"],
    ) -> None: ...
...
class QCameraExposure(QtCore.QObject):
    ...
    class FlashModes(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QCameraExposure.FlashModes", "QCameraExposure.FlashMode"]
...
class QCameraImageCapture(QtCore.QObject, QMediaBindableInterface):
    ...
    class CaptureDestinations(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QCameraImageCapture.CaptureDestinations", "QCameraImageCapture.CaptureDestination"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QCameraImageProcessingControl(QMediaControl):
    ...
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    def setParameter(
        self, parameter: "QCameraImageProcessingControl.ProcessingParameter", value: typing.Any
    ) -> None: ...
...
class QCameraViewfinderSettingsControl(QMediaControl):
    ...
    def setViewfinderParameter(
        self, parameter: "QCameraViewfinderSettingsControl.ViewfinderParameter", value: typing.Any
    ) -> None: ...
...
class QVideoFrame(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, bytes: int, size: QtCore.QSize, bytesPerLine: int, format: "QVideoFrame.PixelFormat"
    ) -> None: ...
    @typing.overload
...
class QVideoSurfaceFormat(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, size: QtCore.QSize, format: QVideoFrame.PixelFormat, type: QAbstractVideoBuffer.HandleType = ...
    ) -> None: ...
    @typing.overload
