...
class QGLFormat(PyQt5.sipsimplewrapper):
    ...
    class OpenGLVersionFlags(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QGLFormat.OpenGLVersionFlags", "QGLFormat.OpenGLVersionFlag"]
...
class QGLContext(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def drawTexture(
        self, point: typing.Union[QtCore.QPointF, QtCore.QPoint], textureId: int, textureTarget: int = ...
    ) -> None: ...
    @typing.overload
...
class QGLWidget(QtWidgets.QWidget):
    ...
    def setContext(
        self, context: QGLContext, shareContext: typing.Optional[QGLContext] = ..., deleteOldContext: bool = ...
    ) -> None: ...
