...
class QJSEngine(QtCore.QObject):
    ...
    def installTranslatorFunctions(
        self, object: typing.Union["QJSValue", "QJSValue.SpecialValue", bool, int, float, str] = ...
    ) -> None: ...
...
class QJSValue(PyQt5.sipsimplewrapper):
    ...
    def callAsConstructor(
        self, args: typing.Iterable[typing.Union["QJSValue", "QJSValue.SpecialValue", bool, int, float, str]] = ...
    ) -> "QJSValue": ...
    ...
    @typing.overload
    def setProperty(
        self, name: str, value: typing.Union["QJSValue", "QJSValue.SpecialValue", bool, int, float, str]
    ) -> None: ...
    @typing.overload
    def setProperty(
        self, arrayIndex: int, value: typing.Union["QJSValue", "QJSValue.SpecialValue", bool, int, float, str]
    ) -> None: ...
    @typing.overload
    ...
    def setPrototype(
        self, prototype: typing.Union["QJSValue", "QJSValue.SpecialValue", bool, int, float, str]
    ) -> None: ...
    def prototype(self) -> "QJSValue": ...
    def strictlyEquals(
        self, other: typing.Union["QJSValue", "QJSValue.SpecialValue", bool, int, float, str]
    ) -> bool: ...
...
class QQmlComponent(QtCore.QObject):
    ...
    def createWithInitialProperties(
        self, initialProperties: typing.Dict[str, typing.Any], context: typing.Optional["QQmlContext"] = ...
    ) -> QtCore.QObject: ...
    @typing.overload
...
class QQmlImageProviderBase(PyQt5.sip.wrapper):
    ...
    class Flags(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QQmlImageProviderBase.Flags", "QQmlImageProviderBase.Flag"]
...
class QQmlExpression(QtCore.QObject):
    ...
    @typing.overload
    def __init__(
        self, a0: QQmlContext, a1: QtCore.QObject, a2: str, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
@typing.overload
def qmlRegisterType(
    a0: type, uri: str, major: int, minor: int, qmlName: str, attachedProperties: type = ...
) -> int: ...
@typing.overload
def qmlRegisterType(
    a0: type, revision: int, uri: str, major: int, minor: int, qmlName: str, attachedProperties: type = ...
) -> int: ...
@typing.overload
...
def qmlRegisterRevision(
    a0: type, revision: int, uri: str, major: int, minor: int, attachedProperties: type = ...
) -> int: ...
