...
class QObject(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def findChildren(
        self, type: type, name: str = ..., options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...
    ) -> typing.List["QObject"]: ...
    @typing.overload
    def findChildren(
        self, types: typing.Tuple, name: str = ..., options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...
    ) -> typing.List["QObject"]: ...
    @typing.overload
    def findChildren(
        self, type: type, regExp: "QRegExp", options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...
    ) -> typing.List["QObject"]: ...
    @typing.overload
    def findChildren(
        self,
    ...
    @typing.overload
    def findChildren(
        self, type: type, re: "QRegularExpression", options: typing.Union[Qt.FindChildOptions, Qt.FindChildOption] = ...
    ) -> typing.List["QObject"]: ...
    @typing.overload
    def findChildren(
        self,
...
class QAbstractEventDispatcher(QObject):
    ...
    def filterNativeEvent(
        self, eventType: typing.Union["QByteArray", bytes, bytearray], message: PyQt5.sip.voidptr
    ...
    def processEvents(
        self, flags: typing.Union["QEventLoop.ProcessEventsFlags", "QEventLoop.ProcessEventsFlag"]
    ) -> bool: ...
    @staticmethod
...
class QAbstractItemModel(QObject):
    ...
    class CheckIndexOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QAbstractItemModel.CheckIndexOptions", "QAbstractItemModel.CheckIndexOption"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def checkIndex(
        self,
        index: QModelIndex,
        options: typing.Union["QAbstractItemModel.CheckIndexOptions", "QAbstractItemModel.CheckIndexOption"] = ...,
    ) -> bool: ...
    def moveColumn(
        self, sourceParent: QModelIndex, sourceColumn: int, destinationParent: QModelIndex, destinationChild: int
    ) -> bool: ...
    def moveRow(
        self, sourceParent: QModelIndex, sourceRow: int, destinationParent: QModelIndex, destinationChild: int
    ) -> bool: ...
    def moveColumns(
        self,
...
class QByteArray(PyQt5.sipsimplewrapper):
    ...
    def __add__(
        self, a1: typing.Union["QByteArray", bytes, bytearray], a2: typing.Union["QByteArray", bytes, bytearray]
    ) -> "QByteArray": ...
    @staticmethod
    ...
    @typing.overload
    def toBase64(
        self, options: typing.Union["QByteArray.Base64Options", "QByteArray.Base64Option"]
    ) -> "QByteArray": ...
    ...
    @typing.overload
    def replace(
        self, before: typing.Union["QByteArray", bytes, bytearray], after: typing.Union["QByteArray", bytes, bytearray]
    ) -> "QByteArray": ...
    @typing.overload
...
class QCalendar(PyQt5.sipsimplewrapper):
    ...
    def standaloneMonthName(
        self, locale: "QLocale", month: int, year: int = ..., format: "QLocale.FormatType" = ...
    ) -> str: ...
...
class QCommandLineOption(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, names: typing.Iterable[str], description: str, valueName: str = ..., defaultValue: str = ...
    ) -> None: ...
    @typing.overload
...
class QCoreApplication(QObject):
    ...
    @staticmethod
    def processEvents(
        flags: typing.Union["QEventLoop.ProcessEventsFlags", "QEventLoop.ProcessEventsFlag"] = ...
    ) -> None: ...
    @typing.overload
    @staticmethod
    def processEvents(
        flags: typing.Union["QEventLoop.ProcessEventsFlags", "QEventLoop.ProcessEventsFlag"], maxtime: int
    ) -> None: ...
    @staticmethod
    def exec() -> int: ...
    @staticmethod
...
class QCryptographicHash(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def hash(
        data: typing.Union[QByteArray, bytes, bytearray], method: "QCryptographicHash.Algorithm"
    ) -> QByteArray: ...
...
class QDateTime(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, date: typing.Union[QDate, datetime.date], time: typing.Union[QTime, datetime.time], timeZone: "QTimeZone"
    ) -> None: ...
    @staticmethod
...
class QDir(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, path: str, nameFilter: str, sort: "QDir.SortFlags" = ..., filters: "QDir.Filters" = ...
    ) -> None: ...
...
class QDirIterator(PyQt5.sipsimplewrapper):
    ...
    class IteratorFlags(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QDirIterator.IteratorFlags", "QDirIterator.IteratorFlag"]
...
class QEventLoop(QObject):
    ...
    class ProcessEventsFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QEventLoop.ProcessEventsFlags", "QEventLoop.ProcessEventsFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    @typing.overload
    def processEvents(
        self, flags: typing.Union["QEventLoop.ProcessEventsFlags", "QEventLoop.ProcessEventsFlag"], maximumTime: int
    ) -> None: ...
...
class QFileDevice(QIODevice):
    ...
    class FileHandleFlags(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QFileDevice.FileHandleFlags", "QFileDevice.FileHandleFlag"]
    ...
    def setFileTime(
        self, newDate: typing.Union[QDateTime, datetime.datetime], fileTime: "QFileDevice.FileTime"
    ) -> bool: ...
    ...
    def setPermissions(
        self, permissionSpec: typing.Union["QFileDevice.Permissions", "QFileDevice.Permission"]
    ) -> bool: ...
...
class QFile(QFileDevice):
    ...
    @staticmethod
    def setPermissions(
        filename: str, permissionSpec: typing.Union[QFileDevice.Permissions, QFileDevice.Permission]
    ) -> bool: ...
    @typing.overload
    def permissions(self) -> QFileDevice.Permissions: ...
    @typing.overload
    ...
    def open(
        ...
        handleFlags: typing.Union[QFileDevice.FileHandleFlags, QFileDevice.FileHandleFlag] = ...,
    ) -> bool: ...
    @typing.overload
...
class QItemSelectionModel(QObject):
    ...
    class SelectionFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QItemSelectionModel.SelectionFlags", "QItemSelectionModel.SelectionFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def setCurrentIndex(
        self,
        index: QModelIndex,
        command: typing.Union["QItemSelectionModel.SelectionFlags", "QItemSelectionModel.SelectionFlag"],
    ) -> None: ...
    @typing.overload
    def select(
        self,
...
class QJsonDocument(PyQt5.sipsimplewrapper):
    ...
    def __init__(
        ...
        object: typing.Dict[
            str,
            typing.Union["QJsonValue", "QJsonValue.Type", typing.Iterable["QJsonValue"], bool, int, float, None, str],
        ],
    ) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def fromJson(
        json: typing.Union[QByteArray, bytes, bytearray], error: typing.Optional[QJsonParseError] = ...
    ) -> "QJsonDocument": ...
    ...
    @staticmethod
    def fromBinaryData(
        data: typing.Union[QByteArray, bytes, bytearray], validation: "QJsonDocument.DataValidation" = ...
    ) -> "QJsonDocument": ...
...
class QLocale(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def matchingLocales(
        language: "QLocale.Language", script: "QLocale.Script", country: "QLocale.Country"
    ) -> typing.List["QLocale"]: ...
    @staticmethod
    ...
    @typing.overload
    def toString(
        self, dateTime: typing.Union[QDateTime, datetime.datetime], format: "QLocale.FormatType" = ...
    ) -> str: ...
    @typing.overload
    def toString(
        self, dateTime: typing.Union[QDateTime, datetime.datetime], format: "QLocale.FormatType", cal: QCalendar
    ) -> str: ...
    @typing.overload
    ...
    @typing.overload
    def toString(
        self, date: typing.Union[QDate, datetime.date], format: "QLocale.FormatType", cal: QCalendar
    ) -> str: ...
    @typing.overload
...
class QMessageAuthenticationCode(PyQt5.sipsimplewrapper):
    def __init__(
        self, method: QCryptographicHash.Algorithm, key: typing.Union[QByteArray, bytes, bytearray] = ...
    ) -> None: ...
    @staticmethod
    def hash(
...
class QOperatingSystemVersion(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, osType: "QOperatingSystemVersion.OSType", vmajor: int, vminor: int = ..., vmicro: int = ...
    ) -> None: ...
    @typing.overload
...
class QProcess(QIODevice):
    ...
    def setStandardErrorFile(
        self, fileName: str, mode: typing.Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = ...
    ) -> None: ...
...
class QRectF(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, atopLeft: typing.Union[QPointF, QPoint], abottomRight: typing.Union[QPointF, QPoint]
    ) -> None: ...
    @typing.overload
...
class QRegularExpression(PyQt5.sipsimplewrapper):
    ...
    class PatternOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QRegularExpression.PatternOptions", "QRegularExpression.PatternOption"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class MatchOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QRegularExpression.MatchOptions", "QRegularExpression.MatchOption"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def __init__(
        self,
        pattern: str,
        options: typing.Union["QRegularExpression.PatternOptions", "QRegularExpression.PatternOption"] = ...,
    ) -> None: ...
    @typing.overload
    ...
    def globalMatch(
        ...
        matchOptions: typing.Union["QRegularExpression.MatchOptions", "QRegularExpression.MatchOption"] = ...,
    ...
    def setPatternOptions(
        self, options: typing.Union["QRegularExpression.PatternOptions", "QRegularExpression.PatternOption"]
    ) -> None: ...
...
class QSocketNotifier(QObject):
    ...
    def __init__(
        self, socket: PyQt5.sip.voidptr, a1: "QSocketNotifier.Type", parent: typing.Optional[QObject] = ...
    ) -> None: ...
    def event(self, a0: QEvent) -> bool: ...
...
class QStandardPaths(PyQt5.sipsimplewrapper):
    ...
    class LocateOptions(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QStandardPaths.LocateOptions", "QStandardPaths.LocateOption"]
    ...
    @staticmethod
    def locateAll(
        type: "QStandardPaths.StandardLocation", fileName: str, options: "QStandardPaths.LocateOptions" = ...
    ) -> typing.List[str]: ...
    @staticmethod
    def locate(
        type: "QStandardPaths.StandardLocation", fileName: str, options: "QStandardPaths.LocateOptions" = ...
...
class QTextBoundaryFinder(PyQt5.sipsimplewrapper):
    ...
    class BoundaryReasons(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QTextBoundaryFinder.BoundaryReasons", "QTextBoundaryFinder.BoundaryReason"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QTextCodec(PyQt5.sip.wrapper):
    ...
    class ConversionFlags(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QTextCodec.ConversionFlags", "QTextCodec.ConversionFlag"]
    ...
    class ConverterState(PyQt5.sipsimplewrapper):
        def __init__(
            self, flags: typing.Union["QTextCodec.ConversionFlags", "QTextCodec.ConversionFlag"] = ...
        ) -> None: ...
    ...
    @typing.overload
    def toUnicode(
        self, in_: PyQt5.sip.array[bytes], state: typing.Optional["QTextCodec.ConverterState"] = ...
    ) -> str: ...
...
class QTextEncoder(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def __init__(
        self, codec: QTextCodec, flags: typing.Union[QTextCodec.ConversionFlags, QTextCodec.ConversionFlag]
    ) -> None: ...
...
class QTextStream(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, array: QByteArray, mode: typing.Union[QIODevice.OpenMode, QIODevice.OpenModeFlag] = ...
    ) -> None: ...
    def locale(self) -> QLocale: ...
    def setLocale(self, locale: QLocale) -> None: ...
    @typing.overload
...
class QTimeZone(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def displayName(
        self, timeType: "QTimeZone.TimeType", nameType: "QTimeZone.NameType" = ..., locale: QLocale = ...
    ) -> str: ...
    def comment(self) -> str: ...
    def country(self) -> QLocale.Country: ...
...
class QTranslator(QObject):
    ...
    @typing.overload
    def load(
        self, locale: QLocale, fileName: str, prefix: str = ..., directory: str = ..., suffix: str = ...
    ) -> bool: ...
    def isEmpty(self) -> bool: ...
    def translate(
        self, context: str, sourceText: str, disambiguation: typing.Optional[str] = ..., n: int = ...
    ) -> str: ...
...
class QUrl(PyQt5.sipsimplewrapper):
    ...
    class FormattingOptions(PyQt5.sipsimplewrapper):
        ...
        def __init__(
            self,
            f: typing.Union["QUrl.FormattingOptions", "QUrl.UrlFormattingOption", "QUrl.ComponentFormattingOption"],
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class ComponentFormattingOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QUrl.ComponentFormattingOptions", "QUrl.ComponentFormattingOption"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class UserInputResolutionOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QUrl.UserInputResolutionOptions", "QUrl.UserInputResolutionOption"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def matches(
        self,
        url: "QUrl",
        options: typing.Union["QUrl.FormattingOptions", "QUrl.UrlFormattingOption", "QUrl.ComponentFormattingOption"],
    ) -> bool: ...
    def fileName(
        self, options: typing.Union["QUrl.ComponentFormattingOptions", "QUrl.ComponentFormattingOption"] = ...
    ) -> str: ...
    def adjusted(
        self,
        options: typing.Union["QUrl.FormattingOptions", "QUrl.UrlFormattingOption", "QUrl.ComponentFormattingOption"],
    ...
    def fromUserInput(
        ...
        options: typing.Union["QUrl.UserInputResolutionOptions", "QUrl.UserInputResolutionOption"] = ...,
    ) -> "QUrl": ...
    @staticmethod
    ...
    def host(
        self, a0: typing.Union["QUrl.ComponentFormattingOptions", "QUrl.ComponentFormattingOption"] = ...
    ) -> str: ...
...
class QUrlQuery(PyQt5.sipsimplewrapper):
    ...
    def allQueryItemValues(
        self, key: str, options: typing.Union[QUrl.ComponentFormattingOptions, QUrl.ComponentFormattingOption] = ...
    ) -> typing.List[str]: ...
    def queryItemValue(
        self, key: str, options: typing.Union[QUrl.ComponentFormattingOptions, QUrl.ComponentFormattingOption] = ...
    ) -> str: ...
...
class QUuid(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, l: int, w1: int, w2: int, b1: int, b2: int, b3: int, b4: int, b5: int, b6: int, b7: int, b8: int
    ) -> None: ...
    @typing.overload
...
class QXmlStreamReader(PyQt5.sipsimplewrapper):
    ...
    def addExtraNamespaceDeclarations(
        self, extraNamespaceDeclaractions: typing.Iterable[QXmlStreamNamespaceDeclaration]
    ) -> None: ...
