...
class QNearFieldManager(QtCore.QObject):
    ...
    class TargetAccessModes(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QNearFieldManager.TargetAccessModes", "QNearFieldManager.TargetAccessMode"]
        ) -> None: ...
        def __hash__(self) -> int: ...
    ...
    def setTargetAccessModes(
        self, accessModes: typing.Union["QNearFieldManager.TargetAccessModes", "QNearFieldManager.TargetAccessMode"]
    ) -> None: ...
...
class QNearFieldShareManager(QtCore.QObject):
    ...
    class ShareModes(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QNearFieldShareManager.ShareModes", "QNearFieldShareManager.ShareMode"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def setShareModes(
        self, modes: typing.Union["QNearFieldShareManager.ShareModes", "QNearFieldShareManager.ShareMode"]
    ) -> None: ...
    @staticmethod
...
class QNearFieldTarget(QtCore.QObject):
    ...
    class AccessMethods(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QNearFieldTarget.AccessMethods", "QNearFieldTarget.AccessMethod"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def handleResponse(
        self, id: "QNearFieldTarget.RequestId", response: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> bool: ...
    def setResponseForRequest(
        self, id: "QNearFieldTarget.RequestId", response: typing.Any, emitRequestCompleted: bool = ...
    ) -> None: ...
    ...
    def sendCommands(
        self, commands: typing.Iterable[typing.Union[QtCore.QByteArray, bytes, bytearray]]
