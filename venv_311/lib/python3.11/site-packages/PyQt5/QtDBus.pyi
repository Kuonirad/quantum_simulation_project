...
class QDBusAbstractInterface(QtCore.QObject):
    def __init__(
        self, service: str, path: str, interface: str, connection: "QDBusConnection", parent: QtCore.QObject
    ) -> None: ...
    ...
    def callWithCallback(
        self, method: str, args: typing.Iterable[typing.Any], returnMethod: PYQT_SLOT, errorMethod: PYQT_SLOT
    ) -> bool: ...
    @typing.overload
...
class QDBusConnection(PyQt5.sipsimplewrapper):
    ...
    class RegisterOptions(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QDBusConnection.RegisterOptions", "QDBusConnection.RegisterOption"]
        ) -> None: ...
    ...
    class ConnectionCapabilities(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QDBusConnection.ConnectionCapabilities", "QDBusConnection.ConnectionCapability"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def registerObject(
        ...
        options: typing.Union["QDBusConnection.RegisterOptions", "QDBusConnection.RegisterOption"] = ...,
    ) -> bool: ...
    @typing.overload
    def registerObject(
        self,
    ...
    @typing.overload
    def disconnect(
        self, service: str, path: str, interface: str, name: str, signature: str, slot: PYQT_SLOT
    ) -> bool: ...
    @typing.overload
    def disconnect(
        self,
    ...
    def callWithCallback(
        self, message: "QDBusMessage", returnMethod: PYQT_SLOT, errorMethod: PYQT_SLOT, timeout: int = ...
    ) -> bool: ...
...
class QDBusServiceWatcher(QtCore.QObject):
    ...
    class WatchMode(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QDBusServiceWatcher.WatchMode", "QDBusServiceWatcher.WatchModeFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def connection(self) -> QDBusConnection: ...
    def setWatchMode(
        self, mode: typing.Union["QDBusServiceWatcher.WatchMode", "QDBusServiceWatcher.WatchModeFlag"]
    ) -> None: ...
