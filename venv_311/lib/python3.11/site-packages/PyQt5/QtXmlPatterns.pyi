...
class QAbstractMessageHandler(QtCore.QObject):
    ...
    def handleMessage(
        self, type: QtCore.QtMsgType, description: str, identifier: QtCore.QUrl, sourceLocation: "QSourceLocation"
    ) -> None: ...
    def message(
        self,
...
class QXmlName(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, namePool: "QXmlNamePool", localName: str, namespaceUri: str = ..., prefix: str = ...
    ) -> None: ...
    @typing.overload
...
class QXmlSchemaValidator(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def validate(
        self, data: typing.Union[QtCore.QByteArray, bytes, bytearray], documentUri: QtCore.QUrl = ...
    ) -> bool: ...
