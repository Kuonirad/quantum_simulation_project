...
class QAbstractTextDocumentLayout(QtCore.QObject):
    ...
    def hitTest(
        self, point: typing.Union[QtCore.QPointF, QtCore.QPoint], accuracy: QtCore.Qt.HitTestAccuracy
    ) -> int: ...
...
class QTextObjectInterface(PyQt5.sipsimplewrapper):
    ...
    def drawObject(
        self, painter: "QPainter", rect: QtCore.QRectF, doc: "QTextDocument", posInDocument: int, format: "QTextFormat"
    ) -> None: ...
...
class QBackingStore(PyQt5.sipsimplewrapper):
    ...
    def flush(
        self, region: "QRegion", window: typing.Optional["QWindow"] = ..., offset: QtCore.QPoint = ...
    ) -> None: ...
    def paintDevice(self) -> "QPaintDevice": ...
...
class QPixmap(QPaintDevice):
    ...
    def __init__(
        ...
        flags: typing.Union[QtCore.Qt.ImageConversionFlags, QtCore.Qt.ImageConversionFlag] = ...,
    ) -> None: ...
    @typing.overload
    ...
    def convertFromImage(
        self, img: "QImage", flags: typing.Union[QtCore.Qt.ImageConversionFlags, QtCore.Qt.ImageConversionFlag] = ...
    ) -> bool: ...
    @staticmethod
    def fromImageReader(
    ...
    @staticmethod
    def fromImage(
        image: "QImage", flags: typing.Union[QtCore.Qt.ImageConversionFlags, QtCore.Qt.ImageConversionFlag] = ...
    ) -> "QPixmap": ...
    ...
    def createMaskFromColor(
        self, maskColor: typing.Union["QColor", QtCore.Qt.GlobalColor], mode: QtCore.Qt.MaskMode = ...
    ) -> "QBitmap": ...
...
class QBrush(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, color: typing.Union[QColor, QtCore.Qt.GlobalColor], style: QtCore.Qt.BrushStyle = ...
    ) -> None: ...
    @typing.overload
...
class QGradient(PyQt5.sipsimplewrapper):
    ...
    def setStops(
        self, stops: typing.Iterable[typing.Tuple[float, typing.Union[QColor, QtCore.Qt.GlobalColor]]]
    ) -> None: ...
...
class QLinearGradient(QGradient):
    ...
    @typing.overload
    def __init__(
        self, start: typing.Union[QtCore.QPointF, QtCore.QPoint], finalStop: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    @typing.overload
...
class QColorSpace(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, primaries: "QColorSpace.Primaries", fun: "QColorSpace.TransferFunction", gamma: float = ...
    ) -> None: ...
    @typing.overload
...
class QDrag(QtCore.QObject):
    ...
    @typing.overload
    def exec(
        self, supportedActions: typing.Union[QtCore.Qt.DropActions, QtCore.Qt.DropAction] = ...
...
class QFileOpenEvent(QtCore.QEvent):
    def openFile(
        self, file: QtCore.QFile, flags: typing.Union[QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag]
    ) -> bool: ...
...
class QShortcutEvent(QtCore.QEvent):
    @typing.overload
    def __init__(
        self, key: typing.Union["QKeySequence", "QKeySequence.StandardKey", str, int], id: int, ambiguous: bool = ...
    ) -> None: ...
    @typing.overload
...
class QTouchEvent(QInputEvent):
    class TouchPoint(PyQt5.sipsimplewrapper):
        ...
        class InfoFlags(PyQt5.sipsimplewrapper):
            ...
            @typing.overload
            def __init__(
                self, f: typing.Union["QTouchEvent.TouchPoint.InfoFlags", "QTouchEvent.TouchPoint.InfoFlag"]
            ) -> None: ...
...
class QIcon(PyQt5.sip.wrapper):
    ...
    @typing.overload
    def actualSize(
        self, window: "QWindow", size: QtCore.QSize, mode: "QIcon.Mode" = ..., state: "QIcon.State" = ...
    ) -> QtCore.QSize: ...
    @typing.overload
...
class QImage(QPaintDevice):
    ...
    @typing.overload
    def __init__(
        self, data: PyQt5.sip.voidptr, width: int, height: int, bytesPerLine: int, format: "QImage.Format"
    ) -> None: ...
    @typing.overload
    def __init__(self, xpm: typing.List[str]) -> None: ...
    @typing.overload
    ...
    @staticmethod
    def fromData(
        data: typing.Union[QtCore.QByteArray, bytes, bytearray], format: typing.Optional[str] = ...
    ) -> "QImage": ...
    @typing.overload
    def save(self, fileName: str, format: typing.Optional[str] = ..., quality: int = ...) -> bool: ...
    @typing.overload
    ...
    @typing.overload
    def loadFromData(
        self, data: typing.Union[QtCore.QByteArray, bytes, bytearray], format: typing.Optional[str] = ...
    ) -> bool: ...
    @typing.overload
    ...
    def createAlphaMask(
        self, flags: typing.Union[QtCore.Qt.ImageConversionFlags, QtCore.Qt.ImageConversionFlag] = ...
    ) -> "QImage": ...
...
class QImageIOHandler(PyQt5.sipsimplewrapper):
    ...
    class Transformations(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QImageIOHandler.Transformations", "QImageIOHandler.Transformation"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QImageReader(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, device: QtCore.QIODevice, format: typing.Union[QtCore.QByteArray, bytes, bytearray] = ...
    ) -> None: ...
    @typing.overload
...
class QImageWriter(PyQt5.sipsimplewrapper):
    ...
    def setTransformation(
        self, orientation: typing.Union[QImageIOHandler.Transformations, QImageIOHandler.Transformation]
    ) -> None: ...
    def transformation(self) -> QImageIOHandler.Transformations: ...
...
class QMatrix4x4(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def viewport(
        self, left: float, bottom: float, width: float, height: float, nearPlane: float = ..., farPlane: float = ...
    ) -> None: ...
    @typing.overload
    ...
    def frustum(
        self, left: float, right: float, bottom: float, top: float, nearPlane: float, farPlane: float
    ) -> None: ...
    @typing.overload
...
class QOpenGLBuffer(PyQt5.sipsimplewrapper):
    ...
    class RangeAccessFlags(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QOpenGLBuffer.RangeAccessFlags", "QOpenGLBuffer.RangeAccessFlag"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def mapRange(
        ...
        offset: int,
        count: int,
        access: typing.Union["QOpenGLBuffer.RangeAccessFlags", "QOpenGLBuffer.RangeAccessFlag"],
    ) -> PyQt5.sip.voidptr: ...
    def unmap(self) -> bool: ...
...
class QOpenGLDebugMessage(PyQt5.sipsimplewrapper):
    ...
    class Sources(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QOpenGLDebugMessage.Sources", "QOpenGLDebugMessage.Source"]
    ...
    class Types(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QOpenGLDebugMessage.Types", "QOpenGLDebugMessage.Type"]
    ...
    class Severities(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QOpenGLDebugMessage.Severities", "QOpenGLDebugMessage.Severity"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def createThirdPartyMessage(
        text: str, id: int = ..., severity: "QOpenGLDebugMessage.Severity" = ..., type: "QOpenGLDebugMessage.Type" = ...
    ) -> "QOpenGLDebugMessage": ...
    @staticmethod
...
class QOpenGLDebugLogger(QtCore.QObject):
    ...
    def disableMessages(
        ...
        severities: typing.Union[QOpenGLDebugMessage.Severities, QOpenGLDebugMessage.Severity] = ...,
    ) -> None: ...
    @typing.overload
    def disableMessages(
        self,
...
class QOpenGLFramebufferObject(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def blitFramebuffer(
        target: "QOpenGLFramebufferObject", source: "QOpenGLFramebufferObject", buffers: int = ..., filter: int = ...
    ) -> None: ...
    @typing.overload
    @staticmethod
    def blitFramebuffer(
...
class QOpenGLShader(QtCore.QObject):
    ...
    class ShaderType(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QOpenGLShader.ShaderType", "QOpenGLShader.ShaderTypeBit"]
...
class QOpenGLShaderProgram(QtCore.QObject):
    ...
    def addCacheableShaderFromSourceFile(
        self, type: typing.Union[QOpenGLShader.ShaderType, QOpenGLShader.ShaderTypeBit], fileName: str
    ) -> bool: ...
    @typing.overload
    ...
    @typing.overload
    def addCacheableShaderFromSourceCode(
        self, type: typing.Union[QOpenGLShader.ShaderType, QOpenGLShader.ShaderTypeBit], source: str
    ) -> bool: ...
    def create(self) -> bool: ...
...
class QOpenGLTexture(PyQt5.sipsimplewrapper):
    ...
    def setMinMagFilters(
        self, minificationFilter: "QOpenGLTexture.Filter", magnificationFilter: "QOpenGLTexture.Filter"
    ) -> None: ...
    ...
    @typing.overload
    def setSwizzleMask(
        self, component: "QOpenGLTexture.SwizzleComponent", value: "QOpenGLTexture.SwizzleValue"
    ) -> None: ...
    @typing.overload
    def setSwizzleMask(
        self,
    ...
    @typing.overload
    def setCompressedData(
        self, dataSize: int, data: PyQt5.sip.voidptr, options: typing.Optional[QOpenGLPixelTransferOptions] = ...
    ) -> None: ...
    @typing.overload
    def setCompressedData(
        self,
    ...
    @typing.overload
    def allocateStorage(
        self, pixelFormat: "QOpenGLTexture.PixelFormat", pixelType: "QOpenGLTexture.PixelType"
    ) -> None: ...
    def faces(self) -> int: ...
    def layers(self) -> int: ...
...
class QOpenGLTextureBlitter(PyQt5.sipsimplewrapper):
    ...
    @staticmethod
    def sourceTransform(
        subTexture: QtCore.QRectF, textureSize: QtCore.QSize, origin: "QOpenGLTextureBlitter.Origin"
    ) -> QMatrix3x3: ...
    @staticmethod
...
class QOpenGLWindow(QPaintDeviceWindow):
    ...
    @typing.overload
    def __init__(
        self, updateBehavior: "QOpenGLWindow.UpdateBehavior" = ..., parent: typing.Optional[QWindow] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
...
class QPageSize(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, pointSize: QtCore.QSize, name: str = ..., matchPolicy: "QPageSize.SizeMatchPolicy" = ...
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    @staticmethod
    def id(
        size: QtCore.QSizeF, units: "QPageSize.Unit", matchPolicy: "QPageSize.SizeMatchPolicy" = ...
...
class QPainter(PyQt5.sipsimplewrapper):
    ...
    class PixmapFragmentHints(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QPainter.PixmapFragmentHints", "QPainter.PixmapFragmentHint"]
    ...
    @typing.overload
    def drawStaticText(
        self, topLeftPosition: typing.Union[QtCore.QPointF, QtCore.QPoint], staticText: "QStaticText"
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawRoundedRect(
        self, rect: QtCore.QRectF, xRadius: float, yRadius: float, mode: QtCore.Qt.SizeMode = ...
    ) -> None: ...
    @typing.overload
    def drawRoundedRect(
        self, x: int, y: int, w: int, h: int, xRadius: float, yRadius: float, mode: QtCore.Qt.SizeMode = ...
    ) -> None: ...
    @typing.overload
    def drawRoundedRect(
        self, rect: QtCore.QRect, xRadius: float, yRadius: float, mode: QtCore.Qt.SizeMode = ...
    ) -> None: ...
    ...
    @typing.overload
    def drawLine(
        self, p1: typing.Union[QtCore.QPointF, QtCore.QPoint], p2: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    def paintEngine(self) -> "QPaintEngine": ...
    def setRenderHints(
        self, hints: typing.Union["QPainter.RenderHints", "QPainter.RenderHint"], on: bool = ...
    ) -> None: ...
    ...
    @typing.overload
    def fillRect(
        self, a0: QtCore.QRectF, a1: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, QGradient]
    ) -> None: ...
    @typing.overload
    def fillRect(
        self, a0: QtCore.QRect, a1: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, QGradient]
    ) -> None: ...
    @typing.overload
    def fillRect(
        self, x: int, y: int, w: int, h: int, b: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, QGradient]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawTiledPixmap(
        self, rectangle: QtCore.QRectF, pixmap: QPixmap, pos: typing.Union[QtCore.QPointF, QtCore.QPoint] = ...
    ) -> None: ...
    @typing.overload
    def drawTiledPixmap(self, rectangle: QtCore.QRect, pixmap: QPixmap, pos: QtCore.QPoint = ...) -> None: ...
    @typing.overload
    def drawTiledPixmap(
        self, x: int, y: int, width: int, height: int, pixmap: QPixmap, sx: int = ..., sy: int = ...
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawPolygon(
        self, points: PyQt5.sip.array[typing.Union[QtCore.QPointF, QtCore.QPoint]], fillRule: QtCore.Qt.FillRule = ...
    ) -> None: ...
    @typing.overload
    ...
    def fillPath(
        self, path: "QPainterPath", brush: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, QGradient]
    ) -> None: ...
    ...
    @typing.overload
    def setClipRect(
        self, x: int, y: int, width: int, height: int, operation: QtCore.Qt.ClipOperation = ...
    ) -> None: ...
    @typing.overload
...
class QPaintEngine(PyQt5.sipsimplewrapper):
    ...
    class PaintEngineFeatures(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QPaintEngine.PaintEngineFeatures", "QPaintEngine.PaintEngineFeature"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def __init__(
        self, features: typing.Union["QPaintEngine.PaintEngineFeatures", "QPaintEngine.PaintEngineFeature"] = ...
    ) -> None: ...
    def hasFeature(
        self, feature: typing.Union["QPaintEngine.PaintEngineFeatures", "QPaintEngine.PaintEngineFeature"]
    ) -> bool: ...
    ...
    def drawTiledPixmap(
        self, r: QtCore.QRectF, pixmap: QPixmap, s: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    ...
    @typing.overload
    def drawPolygon(
        self, points: PyQt5.sip.array[typing.Union[QtCore.QPointF, QtCore.QPoint]], mode: "QPaintEngine.PolygonDrawMode"
    ) -> None: ...
    @typing.overload
...
class QPainterPath(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def addRoundedRect(
        self, x: float, y: float, w: float, h: float, xRadius: float, yRadius: float, mode: QtCore.Qt.SizeMode = ...
    ) -> None: ...
    ...
    @typing.overload
    def quadTo(
        self, ctrlPt: typing.Union[QtCore.QPointF, QtCore.QPoint], endPt: typing.Union[QtCore.QPointF, QtCore.QPoint]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def cubicTo(
        self, ctrlPt1x: float, ctrlPt1y: float, ctrlPt2x: float, ctrlPt2y: float, endPtx: float, endPty: float
    ) -> None: ...
    @typing.overload
...
class QPalette(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def setColor(
        self, acg: "QPalette.ColorGroup", acr: "QPalette.ColorRole", acolor: typing.Union[QColor, QtCore.Qt.GlobalColor]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setBrush(
        self, acr: "QPalette.ColorRole", abrush: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, QGradient]
    ) -> None: ...
    @typing.overload
...
class QPdfWriter(QtCore.QObject, QPagedPaintDevice):
    ...
    def addFileAttachment(
        self, fileName: str, data: typing.Union[QtCore.QByteArray, bytes, bytearray], mimeType: str = ...
    ) -> None: ...
...
class QRawFont(PyQt5.sipsimplewrapper):
    ...
    def alphaMapForGlyph(
        self, glyphIndex: int, antialiasingType: "QRawFont.AntialiasingType" = ..., transform: "QTransform" = ...
    ) -> QImage: ...
    @typing.overload
...
class QScreen(QtCore.QObject):
    ...
    def grabWindow(
        self, window: PyQt5.sip.voidptr, x: int = ..., y: int = ..., width: int = ..., height: int = ...
    ) -> QPixmap: ...
    ...
    def mapBetween(
        self, a: QtCore.Qt.ScreenOrientation, b: QtCore.Qt.ScreenOrientation, rect: QtCore.QRect
    ) -> QtCore.QRect: ...
    def transformBetween(
        self, a: QtCore.Qt.ScreenOrientation, b: QtCore.Qt.ScreenOrientation, target: QtCore.QRect
    ) -> "QTransform": ...
    def angleBetween(self, a: QtCore.Qt.ScreenOrientation, b: QtCore.Qt.ScreenOrientation) -> int: ...
    def setOrientationUpdateMask(
        self, mask: typing.Union[QtCore.Qt.ScreenOrientations, QtCore.Qt.ScreenOrientation]
    ) -> None: ...
...
class QStandardItemModel(QtCore.QAbstractItemModel):
    ...
    def setItemRoleNames(
        self, roleNames: typing.Dict[int, typing.Union[QtCore.QByteArray, bytes, bytearray]]
    ) -> None: ...
    ...
    def setHeaderData(
        self, section: int, orientation: QtCore.Qt.Orientation, value: typing.Any, role: int = ...
    ) -> bool: ...
...
class QSurfaceFormat(PyQt5.sipsimplewrapper):
    ...
    class FormatOptions(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QSurfaceFormat.FormatOptions", "QSurfaceFormat.FormatOption"]
    ...
    @typing.overload
    def __init__(
        self, options: typing.Union["QSurfaceFormat.FormatOptions", "QSurfaceFormat.FormatOption"]
    ) -> None: ...
    @typing.overload
...
class QTextCursor(PyQt5.sipsimplewrapper):
    ...
    def movePosition(
        self, op: "QTextCursor.MoveOperation", mode: "QTextCursor.MoveMode" = ..., n: int = ...
    ) -> bool: ...
    @typing.overload
...
class QTextDocument(QtCore.QObject):
    ...
    class MarkdownFeatures(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QTextDocument.MarkdownFeatures", "QTextDocument.MarkdownFeature"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    def setMarkdown(
        self,
        markdown: str,
        features: typing.Union["QTextDocument.MarkdownFeatures", "QTextDocument.MarkdownFeature"] = ...,
    ) -> None: ...
    def toMarkdown(
        self, features: typing.Union["QTextDocument.MarkdownFeatures", "QTextDocument.MarkdownFeature"] = ...
    ) -> str: ...
    ...
    @typing.overload
    def find(
        self, expr: QtCore.QRegExp, position: int = ..., options: "QTextDocument.FindFlags" = ...
    ) -> QTextCursor: ...
    @typing.overload
    def find(
        self, expr: QtCore.QRegularExpression, position: int = ..., options: "QTextDocument.FindFlags" = ...
    ) -> QTextCursor: ...
    @typing.overload
    def find(self, subString: str, cursor: QTextCursor, options: "QTextDocument.FindFlags" = ...) -> QTextCursor: ...
    @typing.overload
    def find(
        self, expr: QtCore.QRegExp, cursor: QTextCursor, options: "QTextDocument.FindFlags" = ...
    ) -> QTextCursor: ...
    @typing.overload
    def find(
        self, expr: QtCore.QRegularExpression, cursor: QTextCursor, options: "QTextDocument.FindFlags" = ...
    ) -> QTextCursor: ...
...
class QTextFormat(PyQt5.sipsimplewrapper):
    ...
    class PageBreakFlags(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QTextFormat.PageBreakFlags", "QTextFormat.PageBreakFlag"]
...
class QTextLayout(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def drawCursor(
        self, p: QPainter, pos: typing.Union[QtCore.QPointF, QtCore.QPoint], cursorPosition: int
    ) -> None: ...
    @typing.overload
    def drawCursor(
        self, p: QPainter, pos: typing.Union[QtCore.QPointF, QtCore.QPoint], cursorPosition: int, width: int
    ) -> None: ...
    def draw(
        self,
        p: QPainter,
...
class QTouchDevice(PyQt5.sipsimplewrapper):
    ...
    class Capabilities(PyQt5.sipsimplewrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QTouchDevice.Capabilities", "QTouchDevice.CapabilityFlag"]
    ...
    def setCapabilities(
        self, caps: typing.Union["QTouchDevice.Capabilities", "QTouchDevice.CapabilityFlag"]
    ) -> None: ...
...
class QTransform(PyQt5.sipsimplewrapper):
    ...
    def setMatrix(
        self, m11: float, m12: float, m13: float, m21: float, m22: float, m23: float, m31: float, m32: float, m33: float
    ) -> None: ...
...
class QDoubleValidator(QValidator):
    ...
    @typing.overload
    def __init__(
        self, bottom: float, top: float, decimals: int, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
