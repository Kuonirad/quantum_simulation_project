...
class QDesignerActionEditorInterface(QtWidgets.QWidget):
    def __init__(
        self, parent: QtWidgets.QWidget, flags: typing.Union[QtCore.Qt.WindowFlags, QtCore.Qt.WindowType] = ...
    ) -> None: ...
...
class QDesignerFormWindowInterface(QtWidgets.QWidget):
    ...
    class Feature(PyQt5.sipsimplewrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QDesignerFormWindowInterface.Feature", "QDesignerFormWindowInterface.FeatureFlag"]
        ) -> None: ...
