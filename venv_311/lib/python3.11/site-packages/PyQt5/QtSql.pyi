...
class QSqlDriver(QtCore.QObject):
    ...
    def open(
        self, db: str, user: str = ..., password: str = ..., host: str = ..., port: int = ..., options: str = ...
    ) -> bool: ...
    ...
    def lastError(self) -> "QSqlError": ...
    def sqlStatement(
        self, type: "QSqlDriver.StatementType", tableName: str, rec: "QSqlRecord", preparedStatement: bool
    ) -> str: ...
...
class QSqlError(PyQt5.sipsimplewrapper):
    ...
    @typing.overload
    def __init__(
        self, driverText: str = ..., databaseText: str = ..., type: "QSqlError.ErrorType" = ..., errorCode: str = ...
    ) -> None: ...
    @typing.overload
...
class QSqlQuery(PyQt5.sipsimplewrapper):
    ...
    def addBindValue(
        self, val: typing.Any, type: typing.Union["QSql.ParamType", "QSql.ParamTypeFlag"] = ...
    ) -> None: ...
    @typing.overload
    def bindValue(
        self, placeholder: str, val: typing.Any, type: typing.Union["QSql.ParamType", "QSql.ParamTypeFlag"] = ...
    ) -> None: ...
    @typing.overload
    def bindValue(
        self, pos: int, val: typing.Any, type: typing.Union["QSql.ParamType", "QSql.ParamTypeFlag"] = ...
    ) -> None: ...
