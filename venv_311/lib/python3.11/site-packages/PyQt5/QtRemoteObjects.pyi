...
class QRemoteObjectNode(QtCore.QObject):
    ...
    def acquireModel(
        self, name: str, action: "QtRemoteObjects.InitialAction" = ..., rolesHint: typing.Iterable[int] = ...
...
class QRemoteObjectHost(QRemoteObjectHostBase):
    ...
    def setHostUrl(
        self, hostAddress: QtCore.QUrl, allowedSchemas: QRemoteObjectHostBase.AllowedSchemas = ...
    ) -> bool: ...
