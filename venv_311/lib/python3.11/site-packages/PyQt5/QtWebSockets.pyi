...
class QWebSocket(QtCore.QObject):
    ...
    def setPauseMode(
        self, pauseMode: typing.Union[QtNetwork.QAbstractSocket.PauseModes, QtNetwork.QAbstractSocket.PauseMode]
    ) -> None: ...
...
class QWebSocketServer(QtCore.QObject):
    ...
    def __init__(
        self, serverName: str, secureMode: "QWebSocketServer.SslMode", parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
    ...
    def listen(
        self,
        address: typing.Union[QtNetwork.QHostAddress, QtNetwork.QHostAddress.SpecialAddress] = ...,
        port: int = ...,
    ) -> bool: ...
