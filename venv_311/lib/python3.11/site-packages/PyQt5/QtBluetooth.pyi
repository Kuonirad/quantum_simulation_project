...
class QBluetooth(PyQt5.sip.simplewrapper):
    ...
    class AttAccessConstraints(PyQt5.sip.wrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QBluetooth.AttAccessConstraints", "QBluetooth.AttAccessConstraint"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QBluetoothDeviceDiscoveryAgent(QtCore.QObject):
    ...
    class DiscoveryMethods(PyQt5.sip.wrapper):
        ...
        def __init__(
            self,
            f: typing.Union[
                "QBluetoothDeviceDiscoveryAgent.DiscoveryMethods", "QBluetoothDeviceDiscoveryAgent.DiscoveryMethod"
            ],
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
...
class QBluetoothDeviceInfo(PyQt5.sip.wrapper):
    ...
    class ServiceClasses(PyQt5.sip.wrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QBluetoothDeviceInfo.ServiceClasses", "QBluetoothDeviceInfo.ServiceClass"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class CoreConfigurations(PyQt5.sip.wrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QBluetoothDeviceInfo.CoreConfigurations", "QBluetoothDeviceInfo.CoreConfiguration"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    class Fields(PyQt5.sip.wrapper):
        ...
        def __eq__(self, other: object): ...
        def __ixor__(
            self, f: typing.Union["QBluetoothDeviceInfo.Fields", "QBluetoothDeviceInfo.Field"]
    ...
    def setManufacturerData(
        self, manufacturerId: int, data: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> bool: ...
    @typing.overload
    ...
    def setCoreConfigurations(
        self,
        coreConfigs: typing.Union["QBluetoothDeviceInfo.CoreConfigurations", "QBluetoothDeviceInfo.CoreConfiguration"],
    ) -> None: ...
    ...
    @typing.overload
    def setServiceUuids(
        self, uuids: typing.Iterable["QBluetoothUuid"], completeness: "QBluetoothDeviceInfo.DataCompleteness"
    ) -> None: ...
    @typing.overload
...
class QBluetoothServer(QtCore.QObject):
    ...
    def __init__(
        self, serverType: "QBluetoothServiceInfo.Protocol", parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
...
class QBluetoothSocket(QtCore.QIODevice):
    ...
    @typing.overload
    def __init__(
        self, socketType: QBluetoothServiceInfo.Protocol, parent: typing.Optional[QtCore.QObject] = ...
    ) -> None: ...
    @typing.overload
    def __init__(self, parent: typing.Optional[QtCore.QObject] = ...) -> None: ...
    ...
    def doDeviceDiscovery(
        ...
        openMode: typing.Union[QtCore.QIODevice.OpenMode, QtCore.QIODevice.OpenModeFlag],
    ) -> None: ...
...
class QBluetoothUuid(QtCore.QUuid):
    ...
    @typing.overload
    def __init__(
        self, uuid: typing.Tuple[int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int]
    ) -> None: ...
    @typing.overload
...
class QLowEnergyCharacteristic(PyQt5.sip.wrapper):
    ...
    class PropertyTypes(PyQt5.sip.wrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QLowEnergyCharacteristic.PropertyTypes", "QLowEnergyCharacteristic.PropertyType"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
...
class QLowEnergyCharacteristicData(PyQt5.sip.wrapper):
    ...
    def setWriteConstraints(
        self, constraints: typing.Union[QBluetooth.AttAccessConstraints, QBluetooth.AttAccessConstraint]
    ) -> None: ...
    ...
    def setProperties(
        self, properties: typing.Union[QLowEnergyCharacteristic.PropertyTypes, QLowEnergyCharacteristic.PropertyType]
    ) -> None: ...
    def properties(self) -> QLowEnergyCharacteristic.PropertyTypes: ...
...
class QLowEnergyController(QtCore.QObject):
    ...
    def addService(
        self, service: "QLowEnergyServiceData", parent: typing.Optional[QtCore.QObject] = ...
    ) -> "QLowEnergyService": ...
    ...
    @staticmethod
    def createCentral(
        remoteDevice: QBluetoothDeviceInfo, parent: typing.Optional[QtCore.QObject] = ...
    ) -> "QLowEnergyController": ...
    @typing.overload
    @staticmethod
    def createCentral(
        remoteDevice: QBluetoothAddress, localDevice: QBluetoothAddress, parent: typing.Optional[QtCore.QObject] = ...
    ) -> "QLowEnergyController": ...
...
class QLowEnergyDescriptorData(PyQt5.sip.wrapper):
    ...
    def setWritePermissions(
        self,
        writable: bool,
        constraints: typing.Union[QBluetooth.AttAccessConstraints, QBluetooth.AttAccessConstraint] = ...,
    ) -> None: ...
    def readConstraints(self) -> QBluetooth.AttAccessConstraints: ...
...
class QLowEnergyService(QtCore.QObject):
    ...
    class ServiceTypes(PyQt5.sip.wrapper):
        ...
        @typing.overload
        def __init__(
            self, f: typing.Union["QLowEnergyService.ServiceTypes", "QLowEnergyService.ServiceType"]
        ) -> None: ...
        def __hash__(self) -> int: ...
        def __bool__(self) -> int: ...
        def __ne__(self, other: object): ...
    ...
    stateChanged: typing.ClassVar[QtCore.pyqtSignal]
    def writeDescriptor(
        self, descriptor: QLowEnergyDescriptor, newValue: typing.Union[QtCore.QByteArray, bytes, bytearray]
    ) -> None: ...
